                    ...
                    {DOCUMENTS.map((doc, i) => {
                        ...
                        return (
                            <motion.button
                                ...
                                className="group relative text-left bg-white dark:bg-slate-900 rounded-[1.5rem] border-2 border-[#1a2355]/10 dark:border-white/10 p-7 hover:border-[#ee7c7e] hover:-translate-y-1 hover:shadow-2xl transition-all duration-300 overflow-hidden"
                            >
                ...
                {active && (
                    ...
                    >
                        <motion.div
                            ...
                            className="relative w-full max-w-6xl h-[88vh] bg-white dark:bg-slate-900 rounded-[1.25rem] overflow-hidden shadow-2xl flex flex-col"
                            onClick={(e) => e.stopPropagation()}
                        >
