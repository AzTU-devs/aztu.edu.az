                        ...
                        <div className="flex flex-col md:flex-row md:items-center gap-10">
                            {logoUrl ? (
                                <motion.div 
                                    ...
                                    className="w-32 h-32 md:w-40 md:h-40 rounded-[2rem] bg-white p-8 flex items-center justify-center flex-shrink-0 shadow-2xl border-4 border-white/10 z-30"
                                >
                                    <img 
                                        src={logoUrl} 
                                        alt={institute?.name} 
                                ...
                                <div className="w-32 h-32 md:w-40 md:h-40 rounded-[2rem] bg-white/10 animate-pulse border-4 border-white/5 z-30" />
                            ) : null}
                ...
                <div className="flex flex-col lg:flex-row px-4 md:px-10 lg:px-20 py-16 gap-16 w-full max-w-[1600px] mx-auto relative z-10">
                    <aside className="hidden lg:block lg:w-80 flex-shrink-0">
                        <div className="sticky top-28 space-y-8">
                            <ResearchInstituteSidebar instituteSlug={instituteSlug} />
                            <div className="rounded-[1.75rem] bg-[#1a2355] p-10 text-white overflow-hidden relative group shadow-2xl">
