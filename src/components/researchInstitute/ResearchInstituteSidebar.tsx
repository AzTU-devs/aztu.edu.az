          ...
          <Link
            ...
            className={`flex items-center gap-3 px-5 py-3.5 rounded-2xl text-sm font-bold transition-all duration-300 ${
              isActive
                ...
                : "bg-white dark:bg-[#161f42] text-gray-500 dark:text-slate-400 hover:bg-[#1a2355]/5 dark:hover:bg-slate-700/50 hover:text-[#1a2355] dark:hover:text-white border border-transparent hover:border-gray-100 dark:hover:border-slate-700"
            }`}
          >
