...
export default function KtsSidebar() {
  ...
  return (
    <div className="sticky top-28 space-y-4">
      <div className="bg-white dark:bg-[#0d1b3e] rounded-[12px] border-2 border-[#1a2355]/30 dark:border-[#ee7c7e]/10 overflow-hidden shadow-xl">
      ...
      <div className="bg-gradient-to-br from-[#1a2355] to-[#0b1330] rounded-[12px] p-6 text-white shadow-xl">
