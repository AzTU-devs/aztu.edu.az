  ...
  return (
    <div className="w-full rounded-[22px] overflow-hidden border-2 border-[#1a2355]/30 dark:border-white/5 bg-gradient-to-br from-white via-blue-50/40 to-white dark:from-[#0b1632] dark:via-[#0d1b3e] dark:to-[#0b1632] p-6 md:p-8 mb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Bar chart */}
        <div className="lg:col-span-2 bg-white/70 dark:bg-[#101733]/60 rounded-2xl border border-[#1a2355]/15 dark:border-white/5 p-5">
          ...
          {STATS.map((s, i) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white/80 dark:bg-[#101733]/60 rounded-2xl border border-[#1a2355]/15 dark:border-white/5 p-4 flex items-center gap-3"
              >
                <div
