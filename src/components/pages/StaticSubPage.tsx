                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10 -mt-20">
                    ...
                    <div className="lg:col-span-8 space-y-12">
                        <motion.div
                            ...
                            className="bg-white dark:bg-slate-900/40 backdrop-blur-3xl rounded-[2rem] border-2 border-[#1a2355]/30 dark:border-white/10 p-10 md:p-16 shadow-2xl shadow-[#1a2355]/15 relative overflow-hidden group hover:border-[#ee7c7e] transition-all duration-500"
                        >
                    ...
                    <div className="lg:col-span-4 space-y-8">
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="sticky top-28 p-10 rounded-[2rem] bg-[#1a2355] border-2 border-[#1a2355] text-white shadow-2xl shadow-[#1a2355]/30 relative overflow-hidden group hover:border-[#ee7c7e] transition-all duration-500"
                            >
