...
export default function StaticSubPage({ section, item }: Props) {
    ...
    return (
        <main className="relative min-h-screen selection:bg-[#ee7c7e]/30 overflow-hidden bg-white dark:bg-[#0a0c1a]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10 -mt-20">
                    ...
                    <div className="lg:col-span-8 space-y-12">
                        <motion.div
                            ...
                            className="bg-white/80 dark:bg-slate-900/40 backdrop-blur-3xl rounded-[3rem] border-2 border-[#1a2355]/5 dark:border-white/10 p-10 md:p-16 shadow-2xl shadow-blue-900/5 relative overflow-hidden group hover:border-[#ee7c7e]/20 transition-all duration-500"
                        >
                                ...
                                {section.items
                                    ...
                                    .map((other, idx) => (
                                        <Link
                                            ...
                                            className="group relative h-full flex flex-col justify-between p-8 bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[2.5rem] border-2 border-[#1a2355]/5 dark:border-white/10 transition-all duration-500 hover:border-[#ee7c7e]/50 hover:bg-white dark:hover:bg-slate-800 hover:shadow-[0_20px_40px_rgba(0,0,0,0.05)] overflow-hidden"
                                        >
                                            ...
                                            <div className="relative z-10 flex items-center justify-between gap-6">
                                                ...
                                                <div className="w-12 h-12 rounded-2xl bg-[#1a2355]/5 dark:bg-white/5 flex items-center justify-center transition-all duration-500 group-hover:bg-[#ee7c7e] group-hover:text-white shadow-lg border border-[#1a2355]/5 dark:border-white/10">
                                                    <ChevronRightIcon
                                                        sx={{ fontSize: 24 }}
                    ...
                    <div className="lg:col-span-4 space-y-8">
                            <motion.div 
                                ...
                                viewport={{ once: true }}
                                className="sticky top-28 p-10 rounded-[3rem] bg-white dark:bg-slate-900/60 border-2 border-[#1a2355]/5 dark:border-white/10 text-[#1a2355] dark:text-white shadow-2xl relative overflow-hidden group hover:border-[#ee7c7e]/20 transition-all duration-500"
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 mb-8">
                                        <div className="w-2 h-2 rounded-full bg-[#ee7c7e] animate-pulse" />
                                        <span className="text-[#1a2355]/60 dark:text-white/60 text-[10px] font-black uppercase tracking-[0.3em]">Information</span>
                                    </div>
