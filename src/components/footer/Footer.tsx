            ...
            <div className="relative z-10 bg-[#0b1330] overflow-hidden pt-32 md:pt-44">
                ...
                <div className="relative z-20 max-w-[1600px] mx-auto px-5 sm:px-8 md:px-[60px] lg:px-[80px] xl:px-[120px]">
                    ...
                    <div className="flex flex-col xl:flex-row justify-between gap-12 mb-20">
                        ...
                        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[1.75rem] p-10 shadow-2xl relative overflow-hidden group self-start w-full xl:w-[450px] shrink-0">
                        ...
                        <div className="xl:col-span-8 flex flex-wrap gap-6 justify-center xl:justify-start">
                            {[
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="group relative flex items-center justify-center bg-white/10 backdrop-blur-md border border-white/10 rounded-[1.5rem] p-6 w-44 h-24 hover:bg-white/20 hover:border-white/30 transition-all duration-500 overflow-hidden shadow-2xl"
                                >
                        ...
                        <div className="xl:col-span-4 flex flex-wrap gap-4 justify-center xl:justify-end">
                            {[
                                ...
                                <Link
                                    key={label}
                                    href={href}
                                    className="group flex flex-col items-center justify-center bg-white/10 w-28 h-28 rounded-[1.5rem] border border-white/10 hover:bg-[#ee7c7e] hover:border-[#ee7c7e] transition-all duration-500 shadow-xl"
                                >
