            ...
            <div className="relative z-10 max-w-[1600px] mx-auto">
                ...
                <AnimatePresence>
                    {loading && (
                        ...
                        >
                            {[1, 2, 3, 4].map((i) => (
                                <div key={i} className="bg-white/5 rounded-[1.75rem] h-48 border border-white/5" />
                            ))}
                        </motion.div>
                    )}
                </AnimatePresence>
                            ...
                            return (
                                ...
                                >
                                    <Link href={`/announcement/${announcementSlug(announcement.id, announcement.title)}`}>
                                        <div className="group relative h-full flex flex-col bg-white/5 backdrop-blur-sm border border-white/5 rounded-[1.75rem] p-8 transition-all duration-500 hover:bg-white/[0.08] hover:border-[#ee7c7e]/30 hover:shadow-2xl hover:shadow-[#ee7c7e]/5 overflow-hidden">
                                            {/* Hover accent line */}
