        ...
        >
            ...
            <div className="relative z-10 max-w-[1600px] mx-auto">
                ...
                >
                    ...
                    <div className="relative overflow-hidden rounded-[2rem] bg-white/40 dark:bg-white/[0.02] backdrop-blur-sm border border-white dark:border-white/5 p-12">
                        ...
                        {doubled.length > 0 ? (
                            <div className="flex animate-marquee gap-8 w-max items-center">
                                {doubled.map((collab, idx) => (
                                    <a
                                        ...
                                        title={collab.name}
                                        className="group relative flex-shrink-0 flex items-center justify-center w-56 h-36 bg-white dark:bg-white/5 rounded-[1.75rem] shadow-sm hover:shadow-2xl transition-all duration-500 border border-gray-100 dark:border-white/5 hover:border-[#ee7c7e]/20 dark:hover:border-[#ee7c7e]/30 overflow-hidden"
                                    >
                            ...
                            <div className="flex animate-pulse gap-8">
                                {[1, 2, 3, 4, 5, 6].map((i) => (
                                    <div key={i} className="flex-shrink-0 w-56 h-36 bg-gray-100 dark:bg-white/5 rounded-[1.75rem]" />
                                ))}
                            </div>
                        )}
                    </div>
