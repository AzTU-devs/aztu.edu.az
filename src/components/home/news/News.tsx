            ...
            <div className="relative z-10 max-w-[1600px] mx-auto">
                ...
                <AnimatePresence>
                    {listLoading && list.length === 0 && (
                        ...
                        >
                            <div className="lg:w-[55%] bg-gray-100 dark:bg-white/5 rounded-[2.5rem] h-[40rem]" />
                            <div className="lg:w-[45%] grid grid-cols-1 sm:grid-cols-2 gap-8">
                                {[1, 2, 3, 4].map((i) => (
                                    <div key={i} className="bg-gray-100 dark:bg-white/5 rounded-[2rem] h-72" />
                                ))}
                            </div>
                        </motion.div>
                    )}
                    ...
                    <div className="flex flex-col lg:flex-row gap-10 items-stretch">
                        ...
                        >
                            <Link href={`/news/${newsSlug(featured.news_id, featured.title)}`}>
                                <div className="group relative h-full bg-white dark:bg-white/5 rounded-[2.5rem] overflow-hidden border-2 border-[#1a2355]/5 dark:border-white/5 shadow-[0_40px_80px_-20px_rgba(26,35,85,0.2)] transition-all duration-700 hover:shadow-[#ee7c7e]/20 hover:border-[#ee7c7e]/30 hover:-translate-y-2">
                                    {/* Image Section */}
                            ...
                            {rest.map((item, idx) => (
                                ...
                                >
                                    <Link href={`/news/${newsSlug(item.news_id, item.title)}`}>
                                        <div className="group h-full flex flex-col bg-white dark:bg-white/5 rounded-[2rem] border-2 border-[#1a2355]/5 dark:border-white/5 overflow-hidden transition-all duration-700 hover:shadow-[0_30px_60px_-15px_rgba(26,35,85,0.15)] hover:shadow-[#ee7c7e]/10 hover:border-[#ee7c7e]/20 hover:-translate-y-2">
