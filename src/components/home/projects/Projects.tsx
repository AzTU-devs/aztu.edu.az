            ...
            <div className="relative z-10 max-w-[1600px] mx-auto">
                ...
                <AnimatePresence>
                    {loading && (
                        ...
                        >
                            {[1, 2, 3, 4].map((i) => (
                                <div key={i} className="bg-gray-100 dark:bg-white/5 rounded-[1.75rem] h-64 border border-gray-100 dark:border-white/5" />
                            ))}
                        </motion.div>
                    )}
                </AnimatePresence>
                            ...
                            return (
                                ...
                                >
                                    <Link href={`/projects/${project.project_id}`}>
                                        <div className="group relative h-full flex flex-col bg-gray-50/50 dark:bg-white/5 backdrop-blur-sm border border-gray-100 dark:border-white/5 rounded-[1.75rem] p-8 transition-all duration-500 hover:bg-white dark:hover:bg-white/[0.08] hover:shadow-2xl overflow-hidden">
                                            {/* Hover Glow */}
