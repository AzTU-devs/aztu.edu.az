...
export default function Timeline({ items, className = "" }: TimelineProps) {
    return (
        <div className={`relative ${className}`}>
            {/* Vertical Line */}
            <div className="absolute left-[39px] md:left-[47px] top-4 bottom-4 w-1 bg-gradient-to-b from-[#ee7c7e] via-[#1a2355] to-[#ee7c7e] rounded-full opacity-30 dark:opacity-50" />
