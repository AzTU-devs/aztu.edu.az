                            ...
                            <div className="grid grid-cols-3 gap-3">
                                {[
                                    ...
                                    <a
                                        ...
                                        className={`flex flex-col items-center justify-center gap-3 rounded-[1.25rem] p-4 text-white/60 bg-white/5 border border-white/5 transition-all duration-300 group ${color} hover:text-white active:scale-95`}
                                    >
                                      ...
                                      return (
                                        <div key={header.id}>
                                            <Link
                                                ...
                                                onClick={() => setIsOpen(false)}
                                                className="w-full flex items-center px-6 py-5 rounded-[1.25rem] text-[14px] font-black text-white/70 hover:text-white bg-white/5 hover:bg-white/10 border border-white/5 transition-colors uppercase tracking-[0.2em] shadow-xl group"
                                            >
                                    ...
                                    return (
                                        <div key={header.id} className="space-y-2">
                                            <button
                                                ...
                                                className={`w-full flex items-center justify-between px-6 py-5 rounded-[1.25rem] text-left text-[14px] font-black uppercase tracking-[0.2em] transition-colors duration-200 shadow-xl border ${
                                                    isExpanded
                                            ...
                                            {isExpanded && (
                                                <div
                                                    className="overflow-hidden rounded-[1.25rem] bg-white/[0.03] border border-white/5 px-2 py-2 mb-4"
                                                >
