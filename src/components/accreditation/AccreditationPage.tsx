          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {programs.map((prog, i) => (
              <motion.div
                ...
                className="bg-white/80 dark:bg-[#0d1b3e]/80 backdrop-blur-xl rounded-[1.5rem] border-2 border-[#1a2355]/30 dark:border-white/5 overflow-hidden shadow-lg hover:border-[#ee7c7e]/30 transition-all duration-300 group flex flex-col"
              >
