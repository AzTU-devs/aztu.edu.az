...
export default function DepartmentSidebar({ departmentSlug }: Props) {
    ...
    return (
        <nav
            ...
            className="relative bg-white dark:bg-slate-900/70 backdrop-blur-xl rounded-[1.375rem] border-2 border-[#1a2355]/10 dark:border-white/10 shadow-xl shadow-[#1a2355]/5 overflow-hidden"
        >
            {/* Decorative blur */}
