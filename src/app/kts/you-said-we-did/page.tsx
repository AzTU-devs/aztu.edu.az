        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10 -mt-16">
          <div className="lg:col-span-8 space-y-4">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center gap-4 rounded-[1.5rem] border-2 border-dashed border-[#1a2355]/15 dark:border-white/10 p-16 text-center">
              ...
              <>
                ...
                <motion.div
                  ...
                  className="overflow-hidden rounded-[1.5rem] border-2 border-[#1a2355]/20 dark:border-white/5 shadow-2xl shadow-blue-900/5 bg-white/80 dark:bg-[#0d1b3e]/80 backdrop-blur-xl"
                >
