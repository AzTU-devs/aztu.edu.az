            ...
            <div className="relative pt-24 pb-32">
                ...
                <div className="max-w-[1400px] mx-auto px-[40px] md:px-[80px] xl:px-[120px]">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ duration: 0.8 }}
                        className="relative mb-24 p-10 md:p-16 rounded-[2rem] bg-[#1a2355] dark:bg-white/[0.02] border border-white/10 shadow-[0_50px_100px_rgba(0,0,0,0.2)] overflow-hidden text-center"
                    >
                    ...
                    <div className="mb-32">
                        ...
                        <div className="rounded-[1.75rem] bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 p-12 md:p-16 flex flex-col items-center text-center shadow-xl">
