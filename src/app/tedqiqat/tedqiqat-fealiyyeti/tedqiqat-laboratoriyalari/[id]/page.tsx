                    ...
                    <div className="lg:col-span-2 space-y-8">
                        ...
                        {lab.html_content ? (
                            <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                className="bg-white dark:bg-slate-800 rounded-[1.75rem] p-8 md:p-10 shadow-sm border border-gray-100 dark:border-slate-700"
                            >
                        ...
                        {uniqueGallery.length > 0 ? (
                            <motion.div
                                ...
                                className="bg-white dark:bg-slate-800 rounded-[1.75rem] p-6 md:p-8 shadow-sm border border-gray-100 dark:border-slate-700"
                            >
                                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div className="space-y-8">
                        ...
                        {cafedraName ? (
                            <motion.div
                                initial={{ opacity: 0, x: 20 }}
                                animate={{ opacity: 1, x: 0 }}
                                className="bg-[#1a2355] rounded-[1.75rem] p-8 text-white shadow-xl shadow-blue-900/20"
                            >
                                <div className="flex items-center gap-4 mb-6">
                        ...
                        <motion.div
                            ...
                            animate={{ opacity: 1, x: 0 }}
                            transition={{ delay: 0.1 }}
                            className="bg-white dark:bg-slate-800 rounded-[1.75rem] p-8 shadow-sm border border-gray-100 dark:border-slate-700"
                        >
                            <div className="flex items-center gap-4 mb-6">
