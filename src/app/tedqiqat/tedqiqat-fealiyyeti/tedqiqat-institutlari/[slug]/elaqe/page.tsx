    ...
    <div className="space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {contactFields.map((field, idx) => (
            <motion.div
              ...
              className="relative group overflow-hidden rounded-[1.5rem] bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 p-8 shadow-sm hover:shadow-2xl transition-all duration-500"
            >
              <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${field.color} opacity-5 rounded-bl-[3rem] -mr-8 -mt-8 transition-transform group-hover:scale-110`} />
      ...
      >
        <SectionBlock title={currentLang === "az" ? "Məkanımız" : "Our Location"}>
          <div className="relative w-full h-80 rounded-[2rem] overflow-hidden bg-gray-100 dark:bg-slate-800 border-4 border-white dark:border-slate-700 shadow-xl group">
