        ...
        <main className="min-h-screen selection:bg-[#ee7c7e]/30">
            ...
            <div className="relative min-h-[50vh] flex flex-col pt-44 lg:pt-48">
                ...
                <div className="relative z-10 max-w-[1600px] mx-auto w-full px-4 md:px-10 lg:px-20 pb-12">
                    ...
                    <Breadcrumbs
                        items={[
                            { label: t.nav.sections.research || "Research", href: lang === "az" ? "/tedqiqat" : "/research" },
                            { label: p.breadcrumb },
                        ]}
                    />
                ...
                <div className="max-w-[1600px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-4 order-2 lg:order-1">
                        <motion.div 
                            ...
                            viewport={{ once: true }}
                            className="sticky top-32 p-8 rounded-[1.75rem] bg-white dark:bg-slate-800/50 border border-gray-100 dark:border-slate-700 shadow-xl"
                        >
                    ...
                    <div className="lg:col-span-8 order-1 lg:order-2">
                        <motion.div 
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="bg-white dark:bg-slate-800/50 rounded-[1.75rem] p-8 md:p-12 lg:p-16 shadow-xl border border-gray-100 dark:border-slate-700"
                        >
