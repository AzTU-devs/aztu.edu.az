        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10 -mt-20">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white/80 backdrop-blur-3xl rounded-[2rem] border-2 border-[#1a2355]/20 p-10 md:p-14 shadow-2xl shadow-blue-900/5 relative overflow-hidden hover:border-[#ee7c7e]/20 transition-all duration-500"
            >
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            >
              {/* Key Facts Card */}
              <div className="p-8 rounded-[1.75rem] bg-white border-2 border-[#1a2355]/20 shadow-2xl relative overflow-hidden">
              ...
              {/* Supported by — DAAD */}
              <div className="p-8 rounded-[1.75rem] bg-white border-2 border-[#1a2355]/20 shadow-2xl">
