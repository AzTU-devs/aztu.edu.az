    ...
    <main className="min-h-screen bg-white dark:bg-[#0f172a] selection:bg-[#ee7c7e]/30">
      ...
      <div className="relative min-h-[60vh] flex flex-col pt-44 lg:pt-48 overflow-hidden">
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          ...
          <div
            className="absolute top-0 right-0 w-full lg:w-[85%] h-full opacity-15 rounded-bl-[2.5rem] lg:rounded-bl-[10rem] overflow-hidden"
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto space-y-32">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {p.stats.map((stat, i) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-[#0d1b3e] rounded-[12px] p-6 border border-gray-100 dark:border-white/10 shadow-xl flex flex-col items-center text-center gap-3"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-[#1a2355] rounded-[14px] p-10 text-white relative overflow-hidden"
            >
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="bg-white dark:bg-white/5 rounded-[14px] p-10 border border-gray-100 dark:border-white/10 shadow-xl"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-gray-50 dark:bg-white/5 rounded-[14px] p-10 border border-gray-100 dark:border-white/10 flex gap-6 items-start"
            >
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="bg-gray-50 dark:bg-white/5 rounded-[14px] p-10 border border-gray-100 dark:border-white/10"
            >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              {IMAGES.map((src, i) => (
                <motion.div
                  ...
                  className={`relative overflow-hidden rounded-[10px] shadow-lg group ${
