            ...
            >
              {activeTab === "about" && (
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                  ...
                  <div className="lg:col-span-4">
                    <div className="bg-gray-50 dark:bg-white/5 rounded-[14px] p-8 border border-gray-100 dark:border-white/10 shadow-sm">
              ...
              {activeTab === "competitions" && (
                <div className="space-y-12">
                  ...
                  <div className="p-10 rounded-[14px] bg-[#1a2355] text-white">
              ...
              {activeTab === "contact" && (
                <div className="space-y-12 max-w-4xl mx-auto">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white dark:bg-white/5 rounded-[12px] p-8 border border-gray-100 dark:border-white/10 shadow-sm flex items-start gap-6">
                    ...
                    <div className="bg-white dark:bg-white/5 rounded-[12px] p-8 border border-gray-100 dark:border-white/10 shadow-sm flex items-start gap-6 md:col-span-2">
                      <div className="w-14 h-14 rounded-2xl bg-[#ee7c7e]/10 flex items-center justify-center shrink-0">
