    ...
    <main className="min-h-screen selection:bg-[#ee7c7e]/30">
      ...
      <div className="relative min-h-[60vh] flex flex-col pt-44 lg:pt-48 overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1600px] mx-auto w-full px-4 md:px-10 lg:px-20 pb-20">
          <Breadcrumbs
              items={[
                  { label: lang === "az" ? "İcma" : "Community", href: lang === "az" ? "/az/icma" : "/en/community" },
      ...
      <div className="px-4 md:px-10 lg:px-20 py-24 space-y-32 bg-white dark:bg-[#0b1330] relative overflow-hidden">
        <div className="relative z-10 max-w-[1600px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {p.functions.map((fn, i) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-white/5 rounded-[1.5rem] p-8 border border-gray-100 dark:border-white/10 shadow-sm hover:shadow-lg hover:border-[#ee7c7e]/20 transition-all duration-300 group"
                >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-slate-50 dark:bg-white/5 rounded-[2rem] p-10 md:p-16 border border-slate-100 dark:border-white/10 mb-32 relative overflow-hidden"
          >
