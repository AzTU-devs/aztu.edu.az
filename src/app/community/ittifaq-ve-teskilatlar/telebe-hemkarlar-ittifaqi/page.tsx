            ...
            >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                    ...
                    <div className="lg:col-span-4 grid grid-cols-2 gap-4">
                      {p.about.stats.map((stat, i) => (
                        <div key={i} className="bg-gray-50 dark:bg-white/5 rounded-[1.5rem] p-6 border border-gray-100 dark:border-white/10 flex flex-col items-center text-center gap-2 shadow-sm">
              ...
              {activeTab === "chair" && (
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                  ...
                  <div className="lg:col-span-4 space-y-6">
                    <div className="relative w-full aspect-[3/4] rounded-[1.75rem] overflow-hidden shadow-2xl">
                      <Image
                        src={CHAIR_PHOTO}
                        alt={p.chair.name}
                        fill
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {p.activities.items.map((item, i) => (
                      <motion.div
                        ...
                        className="bg-white dark:bg-white/5 rounded-[1.75rem] p-8 border border-gray-100 dark:border-white/10 shadow-sm hover:shadow-lg hover:border-[#ee7c7e]/20 transition-all duration-300"
                      >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {p.clubs.items.map((club, i) => (
                      <motion.div
                        ...
                        className="bg-white dark:bg-white/5 rounded-[1.75rem] p-10 border border-gray-100 dark:border-white/10 shadow-sm hover:shadow-xl hover:border-[#ee7c7e]/30 transition-all duration-300 flex flex-col items-center text-center"
                      >
              ...
              {activeTab === "membership" && (
                <div className="space-y-12">
                  ...
                  <div className="flex items-start gap-4 p-8 rounded-[1.5rem] bg-[#ee7c7e]/5 border border-[#ee7c7e]/20">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="bg-white dark:bg-white/5 rounded-[1.75rem] p-10 border border-gray-100 dark:border-white/10 shadow-sm">
                    ...
                    <div className="bg-[#1a2355] rounded-[1.75rem] p-10 text-white">
              ...
              {activeTab === "contact" && (
                <div className="space-y-12 max-w-2xl mx-auto text-center">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div className="flex flex-col items-center gap-4 bg-white dark:bg-white/5 rounded-[1.5rem] p-8 border border-gray-100 dark:border-white/10 shadow-sm">
