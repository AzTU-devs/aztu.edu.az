            ...
            >
              ...
              {activeTab === "chair" && (
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                  ...
                  <div className="lg:col-span-4 space-y-6">
                    <div className="relative w-full aspect-[3/4] rounded-[1.75rem] overflow-hidden shadow-2xl bg-gray-100 flex items-center justify-center">
              ...
              {activeTab === "sdg" && (
                <div className="space-y-12">
                  ...
                  <div className="relative p-10 rounded-[2rem] bg-gradient-to-br from-[#1a2355] to-[#3b6ea8] text-white overflow-hidden shadow-2xl">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {p.sdg.items.map((item, i) => {
                      ...
                      return (
                        <div key={i} className="group bg-white dark:bg-white/5 rounded-[1.75rem] border border-gray-100 dark:border-white/10 shadow-sm hover:shadow-xl transition-all overflow-hidden flex flex-col sm:flex-row">
