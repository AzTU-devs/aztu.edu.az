...
const ROUTES: { az: string; en: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"] }[] = [
    ...
    { az: "beynelmilellesme", en: "internationalization", priority: 0.8, changeFrequency: "monthly" },
    { az: "beynelmilellesme/beynelxalq-terefdasliq/terefdas-universitetler", en: "internationalization/international-partnership/partner-universities", priority: 0.7, changeFrequency: "monthly" },
    { az: "beynelmilellesme/beynelxalq-terefdasliq/ikili-diplom-proqramlari", en: "internationalization/international-partnership/double-degree-programs", priority: 0.7, changeFrequency: "monthly" },
    { az: "beynelmilellesme/beynelxalq-terefdasliq/beynelxalq-layiheler", en: "internationalization/international-partnership/international-projects", priority: 0.7, changeFrequency: "monthly" },
    { az: "beynelmilellesme/beynelxalq-terefdasliq/elaqe", en: "internationalization/international-partnership/contact", priority: 0.6, changeFrequency: "yearly" },
    { az: "beynelmilellesme/xarici-telebeler/qebul", en: "internationalization/foreign-students/admission", priority: 0.8, changeFrequency: "monthly" },
    { az: "beynelmilellesme/xarici-telebeler/yerlesme", en: "internationalization/foreign-students/accommodation", priority: 0.7, changeFrequency: "yearly" },
    { az: "beynelmilellesme/xarici-telebeler/viza-ve-miqrasiya", en: "internationalization/foreign-students/visa-and-migration", priority: 0.7, changeFrequency: "yearly" },
    { az: "beynelmilellesme/xarici-telebeler/teqaud-imkanlari", en: "internationalization/foreign-students/scholarship-opportunities", priority: 0.8, changeFrequency: "monthly" },
    { az: "beynelmilellesme/xarici-telebeler/hazirliq-proqrami", en: "internationalization/foreign-students/foundation-program", priority: 0.7, changeFrequency: "yearly" },
    { az: "beynelmilellesme/mubadile-proqramlari/erasmus-mubadile", en: "internationalization/exchange-programs/erasmus-mobility", priority: 0.8, changeFrequency: "monthly" },
    { az: "beynelmilellesme/mubadile-proqramlari/ikiterefli-mubadile", en: "internationalization/exchange-programs/bilateral-exchange", priority: 0.7, changeFrequency: "monthly" },
    { az: "beynelmilellesme/mubadile-proqramlari/orhun-mubadile-proqrami", en: "internationalization/exchange-programs/orhun-exchange-program", priority: 0.7, changeFrequency: "monthly" },
    { az: "beynelmilellesme/mubadile-proqramlari/terefdas-universitetler", en: "internationalization/exchange-programs/partner-universities", priority: 0.7, changeFrequency: "monthly" },
