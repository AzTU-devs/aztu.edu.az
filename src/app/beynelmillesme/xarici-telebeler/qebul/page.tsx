                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    ...
                    <div className="lg:col-span-8 space-y-20">
                        ...
                        <section>
                            ...
                            <div className="bg-white dark:bg-slate-900 rounded-[1.75rem] border border-gray-100 dark:border-slate-800 p-8 lg:p-12 shadow-xl shadow-blue-900/5 transition-all duration-500">
                        ...
                        {/* Application Process */}
                        <section className="bg-white dark:bg-slate-900 rounded-[1.75rem] border border-gray-100 dark:border-slate-800 p-8 lg:p-12 shadow-xl shadow-blue-900/5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <motion.section 
                                ...
                                viewport={{ once: true }}
                                className="bg-[#0a0c1a] rounded-[1.75rem] p-10 text-white relative overflow-hidden group"
                            >
                            ...
                            <motion.section 
                                ...
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                                className="bg-white dark:bg-slate-900 rounded-[1.75rem] border-2 border-[#1a2355]/30 dark:border-[#ee7c7e]/10 p-10 shadow-xl shadow-blue-900/5 group"
                            >
                        ...
                        {/* Important Note */}
                        <section className="bg-amber-50 dark:bg-amber-900/10 rounded-[1.75rem] border border-amber-100 dark:border-amber-900/20 p-8 lg:p-12">
