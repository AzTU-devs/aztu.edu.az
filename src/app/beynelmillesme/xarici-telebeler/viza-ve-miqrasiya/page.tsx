            ...
            <div className="max-w-[1600px] mx-auto px-4 md:px-10 lg:px-20 py-24">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    <div className="lg:col-span-8 space-y-20">
                        ...
                        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {p.visaSections.map((section: any, idx: number) => (
                                <motion.div
                                    ...
                                    className="bg-white dark:bg-slate-900 p-8 rounded-[1.75rem] border border-gray-100 dark:border-slate-800 shadow-xl shadow-blue-900/5"
                                >
                        ...
                        <section className="bg-blue-50 dark:bg-blue-900/10 rounded-[1.75rem] p-8 lg:p-12 border border-blue-100 dark:border-blue-900/20">
                        ...
                        <section>
                            ...
                            <div className="bg-white dark:bg-slate-900 rounded-[1.75rem] border border-gray-100 dark:border-slate-800 p-8 lg:p-12 shadow-xl shadow-blue-900/5">
