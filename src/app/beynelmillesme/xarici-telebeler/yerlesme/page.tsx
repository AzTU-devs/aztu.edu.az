            ...
            <div className="max-w-[1600px] mx-auto px-4 md:px-10 lg:px-20 py-24">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                    <div className="lg:col-span-8 space-y-12">
                        <div className="grid grid-cols-1 gap-8">
                            {p.content.map((text: string, idx: number) => (
                                <motion.div
                                    ...
                                    className="bg-white dark:bg-slate-900 p-8 lg:p-10 rounded-[14px] border border-gray-100 dark:border-slate-800 shadow-xl shadow-blue-900/5 flex gap-6 items-start"
                                >
                        ...
                        <section className="bg-[#1a2355] rounded-[14px] p-10 lg:p-16 text-white relative overflow-hidden">
                            ...
                            <div className="space-y-4">
                                ...
                                {p.related.map((link: any) => (
                                    <Link
                                        key={link.href}
                                        href={link.href}
                                        className="group flex items-center justify-between bg-white dark:bg-slate-800/50 p-6 rounded-[10px] border border-gray-100 dark:border-slate-700 hover:border-[#ee7c7e] transition-all duration-300 shadow-sm hover:shadow-xl"
                                    >
