                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                    ...
                    <div className="lg:col-span-8 space-y-20">
                        ...
                        <motion.section
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="relative bg-white dark:bg-slate-900 rounded-[1.75rem] p-8 lg:p-12 border border-gray-100 dark:border-slate-800 shadow-xl shadow-blue-900/5 overflow-hidden"
                        >
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                                {p.stages.map((stage, idx) => (
                                    <motion.div
                                        ...
                                        className={`relative rounded-[1.75rem] p-8 lg:p-10 overflow-hidden group transition-all duration-500 hover:-translate-y-1 ${
                                            idx === 0
