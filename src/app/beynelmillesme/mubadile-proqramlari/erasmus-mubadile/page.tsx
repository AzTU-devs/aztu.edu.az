                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                    <div className="lg:col-span-8 space-y-20">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <motion.section
                                ...
                                viewport={{ once: true }}
                                className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-gray-100 dark:border-slate-800 p-8 lg:p-10 shadow-xl shadow-blue-900/5"
                            >
                            ...
                            <motion.section
                                ...
                                className="bg-[#1a2355] text-white rounded-[2.5rem] p-8 lg:p-10 shadow-2xl shadow-blue-900/20 relative overflow-hidden"
                            >
                                ...
                                {p.durations.map((d, idx) => {
                                    ...
                                    return (
                                        <motion.div
                                            ...
                                            className="bg-white dark:bg-slate-900 rounded-[2rem] p-8 border border-gray-100 dark:border-slate-800 shadow-xl shadow-blue-900/5 hover:-translate-y-1 hover:shadow-2xl transition-all duration-500 group"
                                        >
                        ...
                        <section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {p.documentSections.map((doc) => (
                                    <div key={doc.title} className="bg-white dark:bg-slate-900 rounded-[2rem] border border-gray-100 dark:border-slate-800 p-8 shadow-xl shadow-blue-900/5">
                                        <div className="flex items-center gap-4 mb-6">
                        ...
                        <motion.section
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="bg-white dark:bg-slate-900 rounded-[2.5rem] border-2 border-[#1a2355]/30 dark:border-[#ee7c7e]/20 p-8 lg:p-10 shadow-2xl shadow-blue-900/5"
                        >
                    ...
                    <div className="lg:col-span-4">
                        <div className="sticky top-28 space-y-8">
                            <div className="p-10 rounded-[3rem] bg-white dark:bg-slate-900 border-2 border-[#1a2355]/30 dark:border-[#ee7c7e]/20 shadow-2xl relative overflow-hidden">
