                    ...
                    <div className="lg:col-span-8 space-y-12">
                        {p.projects.map((project, idx) => (
                            <motion.div
                                ...
                                className="bg-white dark:bg-slate-900 rounded-[1.75rem] border border-gray-100 dark:border-slate-800 overflow-hidden shadow-xl shadow-blue-900/5 hover:shadow-2xl transition-all duration-500 group"
                            >
