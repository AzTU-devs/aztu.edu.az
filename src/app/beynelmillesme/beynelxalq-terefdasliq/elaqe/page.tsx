...
const SECTION_ICONS = [HandshakeIcon, PublicIcon, SchoolIcon];
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                >
                                                    ...
                                                    <div>
                                                        ...
                                                        <span className="text-sm font-bold text-[#1a2355] dark:text-white group-hover/link:text-[#ee7c7e] transition-colors break-all">
                                                            {section.email}
                                                        </span>
                                                    </div>
                                                </a>
                                                {section.phone && (
                                                    ...
                                                    >
                                                        ...
                                                        <div>
                                                            ...
                                                            <span className="text-sm font-bold text-[#1a2355] dark:text-white group-hover/link:text-[#ee7c7e] transition-colors">
                                                                {section.phone}
                                                            </span>
                                                        </div>
                                                    </a>
                        ...
                        <div className="sticky top-28 space-y-8">
                            ...
                            <div className="p-10 rounded-[14px] bg-white dark:bg-slate-900 border-2 border-[#1a2355]/30 dark:border-[#ee7c7e]/20 shadow-2xl relative overflow-hidden group">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <h3 className="text-2xl font-black text-[#1a2355] dark:text-white tracking-tighter mb-4">AzTU Global Network</h3>
