                    ...
                    <div className="space-y-12">
                        {t.sections.map((section, index) => (
                            <motion.div
                                ...
                                className="relative p-8 md:p-10 rounded-[14px] bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-2 border-[#1a2355]/30 dark:border-white/5 shadow-2xl shadow-blue-900/5 group"
                            >
