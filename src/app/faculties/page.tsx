                ...
                <div className="-mt-24 relative z-10 mb-12">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                        ...
                        <motion.div
                            ...
                            className="lg:col-span-5 relative bg-white dark:bg-slate-900/70 backdrop-blur-xl rounded-[2rem] border-2 border-[#1a2355]/15 dark:border-white/10 p-6 shadow-xl overflow-hidden"
                        >
                ...
                {loading ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-7 relative z-10">
                        {Array.from({ length: 8 }).map((_, i) => (
                            <div
                                key={i}
                                className="animate-pulse bg-white/60 backdrop-blur-xl rounded-[2.5rem] border-2 border-[#1a2355]/10 p-8 h-80"
                            />
                        ))}
                    </div>
                ) : faculties.length === 0 ? (
                    <div className="text-center py-32 bg-white/60 backdrop-blur-3xl rounded-[3rem] border-2 border-dashed border-gray-200 shadow-xl relative z-10">
                        <SchoolIcon
                    ...
                    <div className="text-center py-24 bg-white/60 backdrop-blur-3xl rounded-[3rem] border-2 border-dashed border-gray-200 shadow-xl relative z-10">
                        ...
                        {filtered.map((faculty, i) => {
                            ...
                            return (
                                ...
                                >
                                    <Link
                                        href={aboutLink}
                                        className={`group relative block h-full rounded-[2.5rem] bg-white dark:bg-slate-900/70 backdrop-blur-xl border-2 border-[#1a2355]/10 dark:border-white/10 p-7 transition-all duration-500 overflow-hidden hover:-translate-y-2 hover:border-transparent hover:shadow-2xl ${palette.glow}`}
                                    >
                                        {/* Top color band */}
                                        <div
