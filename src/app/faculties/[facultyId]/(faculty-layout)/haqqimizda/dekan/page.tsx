            ...
            <div className="flex flex-col lg:flex-row gap-12 items-start">
              ...
              <div className="w-full lg:w-80 space-y-8 flex-shrink-0">
                ...
                <div className="space-y-4">
                  {[
                    { icon: EmailIcon, label: currentLang === "az" ? "E-poçt" : "Email", value: director.email, href: `mailto:${director.email}`, color: "text-blue-500 bg-blue-500/10 border-blue-500/20" },
                    { icon: PhoneIcon, label: currentLang === "az" ? "Telefon" : "Phone", value: director.phone, href: `tel:${director.phone}`, color: "text-emerald-500 bg-emerald-500/10 border-emerald-500/20" },
                    { icon: LocationOnIcon, label: currentLang === "az" ? "Otaq" : "Room", value: director.room_number, color: "text-orange-500 bg-orange-500/10 border-orange-500/20" },
              ...
              <div className="flex-1 space-y-10">
                ...
                >
                  <div className="inline-flex items-center gap-3 px-4 py-2 rounded-xl bg-[#ee7c7e]/10 border border-[#ee7c7e]/20 mb-4">
                    ...
                    <span className="text-[#ee7c7e] text-[10px] font-black uppercase tracking-[0.3em]">{currentLang === "az" ? "Fakültə Rəhbəri" : "Faculty Leadership"}</span>
                  </div>
