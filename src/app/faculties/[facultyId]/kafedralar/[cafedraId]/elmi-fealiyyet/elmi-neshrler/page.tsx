...
export default function ElmiNeshrlerPage({ params }: Props) {
  ...
  return (
    <div className="space-y-8">
      <FacultyPanel
        title={currentLang === "az" ? "Elmi nəşrlər" : "Scientific Publications"}
          ...
          <>
            ...
            {years.length === 0 ? (
              <EmptyState
                ...
                hint={
                  currentLang === "az"
                    ? "Bu kafedra üçün elmi nəşr əlavə edilməyib."
                    : "No publications have been added for this department."
                }
              />
            ) : (
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 xl:grid-cols-4">
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="mt-1.5 text-[13px] font-medium text-slate-500 dark:text-slate-400">
                          {currentLang === "az"
                            ? `${bucket.count} nəşr`
                            : `${bucket.count} ${bucket.count === 1 ? "publication" : "publications"}`}
                        </span>
