                ...
                <div className="-mt-20 relative z-10 mb-10">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
                        <motion.div
                            ...
                            className="lg:col-span-5 relative bg-white dark:bg-slate-900/70 backdrop-blur-xl rounded-[1.5rem] border-2 border-[#1a2355]/15 dark:border-white/10 p-5 shadow-xl overflow-hidden"
                        >
                ...
                {loading ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {Array.from({ length: 8 }).map((_, i) => (
                            <div
                                key={i}
                                className="animate-pulse bg-white/60 backdrop-blur-xl rounded-[1.5rem] border-2 border-[#1a2355]/10 p-6 h-56"
                            />
                        ))}
                    </div>
                ) : departments === "ERROR" ? (
                    <div className="text-center py-20 px-6 bg-red-50 dark:bg-red-950/20 rounded-[1.5rem] border border-red-100 dark:border-red-900/30">
                    ...
                    <div className="text-center py-24 bg-white/70 backdrop-blur-xl rounded-[1.75rem] border-2 border-dashed border-gray-200 dark:border-slate-700">
                    ...
                    <div className="text-center py-20 bg-white/70 backdrop-blur-xl rounded-[1.75rem] border-2 border-dashed border-gray-200 dark:border-slate-700">
                        ...
                        {filtered.map((dept, i) => {
                            ...
                            return (
                                ...
                                >
                                    <Link
                                        href={path}
                                        className={`group relative block h-full bg-white dark:bg-slate-900/70 backdrop-blur-xl rounded-[1.5rem] border-2 border-[#1a2355]/10 dark:border-white/10 p-6 transition-all duration-500 overflow-hidden hover:-translate-y-1 hover:border-transparent hover:shadow-2xl ${palette.glow}`}
                                    >
