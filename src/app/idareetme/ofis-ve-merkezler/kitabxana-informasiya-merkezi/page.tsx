      ...
      <div className="px-4 md:px-10 lg:px-20 py-24 bg-white dark:bg-[#0b1330] relative overflow-hidden">
        <div className="relative z-10 max-w-[1600px] mx-auto space-y-32">
            ...
            >
              ...
              <div className="mt-10 flex flex-wrap gap-4">
                {p.departments.map((dep, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-[#1a2355]/5 dark:bg-white/10 border border-[#1a2355]/30 dark:border-white/10"
                  >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-gray-50 dark:bg-white/5 rounded-[14px] p-10 md:p-14 border border-gray-100 dark:border-white/10"
          >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-white dark:bg-white/5 rounded-[14px] p-10 md:p-14 border border-gray-100 dark:border-white/10 shadow-xl relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 p-10 opacity-5 pointer-events-none">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-[#1a2355] rounded-[14px] p-10 md:p-16 text-white"
          >
            <div className="flex items-center gap-4 mb-8">
              <div className="w-1.5 h-10 bg-[#ee7c7e] rounded-full" />
          ...
          >
            ...
            {/* Intro paragraphs */}
            <div className="bg-gray-50 dark:bg-white/5 rounded-[14px] p-10 border border-gray-100 dark:border-white/10 space-y-5">
            ...
            {/* Visitor Chart */}
            <div className="bg-white dark:bg-white/5 rounded-[14px] p-10 md:p-14 border border-gray-100 dark:border-white/10 shadow-sm">
            ...
            {/* Academic Databases */}
            <div className="bg-[#1a2355] rounded-[14px] p-10 md:p-14 text-white">
            ...
            {/* Email Queries */}
            <div className="bg-[#ee7c7e]/10 border border-[#ee7c7e]/20 rounded-[12px] p-10">
            ...
            {/* Future Targets */}
            <div className="bg-gray-50 dark:bg-white/5 rounded-[14px] p-10 border border-gray-100 dark:border-white/10">
