      ...
      <div className="px-4 md:px-10 lg:px-20 py-24 bg-white dark:bg-[#101733] relative overflow-hidden">
        <div className="relative z-10 max-w-[1600px] mx-auto space-y-32">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {p.partnerships.map((item, i) => (
                <motion.div
                  ...
                  className="bg-white dark:bg-white/5 rounded-[22px] p-8 border border-gray-100 dark:border-white/10 shadow-sm hover:shadow-xl hover:border-[#ee7c7e]/20 transition-all duration-300"
                >
          ...
          >
            ...
            <div className="overflow-hidden rounded-[22px] border border-gray-100 dark:border-white/10 shadow-xl">
