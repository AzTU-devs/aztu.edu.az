                            ...
                            {feedbackLoading ? (
                                <div className="space-y-4">
                                    {[0, 1, 2].map((i) => (
                                        <div
                                            key={i}
                                            className="h-40 rounded-[1.5rem] bg-[#1a2355]/5 dark:bg-white/5 animate-pulse"
                                        />
                                    ))}
                                </div>
                            ) : feedback.length === 0 ? (
                                <div className="rounded-[1.5rem] border-2 border-dashed border-[#1a2355]/15 dark:border-white/10 p-10 text-center text-[#1a2355]/50 dark:text-white/40 font-medium">
                                    {t.youSaidWeDidEmpty}
                                </div>
                            ) : (
...
function FeedbackCard({
    ...
    return (
        <motion.div
            ...
            className="overflow-hidden rounded-[1.5rem] border-2 border-[#1a2355]/15 dark:border-[#ee7c7e]/20 bg-white dark:bg-slate-900 shadow-lg shadow-[#1a2355]/5"
        >
...
function FAQAccordion({ 
    ...
    return (
        <div className={`overflow-hidden rounded-[1.5rem] border-2 transition-all duration-500 ${
            isOpen 
