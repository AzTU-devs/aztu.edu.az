...
const PROGRAMMES = [
    { icon: <ComputerIcon sx={{ fontSize: 26 }} />, title: "Information Technologies", duration: "3 years", credential: "Technician Diploma" },
    { icon: <ElectricalServicesIcon sx={{ fontSize: 26 }} />, title: "Electrical Installation & Maintenance", duration: "3 years", credential: "Technician Diploma" },
    { icon: <BuildIcon sx={{ fontSize: 26 }} />, title: "Mechanical Engineering Technology", duration: "3 years", credential: "Technician Diploma" },
    { icon: <EngineeringIcon sx={{ fontSize: 26 }} />, title: "Industrial Automation", duration: "3 years", credential: "Technician Diploma" },
];
...
export default function BakuTechnicalCollegesPage() {
    return (
        <>
            <HeaderChanger />
            <main className="min-h-screen bg-gray-50 dark:bg-[#0f172a]">
                <AboutPageBanner
                    ...
                    subtitle="Higher technical vocational education preparing skilled technicians for Azerbaijan's engineering sector."
                    breadcrumbs={[{ label: "About", href: "/about" }, { label: "Baku Technical Colleges" }]}
                />
                ...
                <div className="px-4 md:px-10 lg:px-20 py-14">
                    ...
                    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="mb-8">
                        <SectionBlock accent title="About Baku Technical Colleges">
                            <div className="space-y-4 text-gray-600 dark:text-gray-300 text-base leading-relaxed">
                                <p>
                                    Baku Technical Colleges (Bakı Texniki Kollecləri) is an affiliated higher vocational institution of Azerbaijan Technical University, established to provide practical, industry-oriented technical education at the sub-degree level.
                                </p>
                                <p>
                                    Graduates earn a Technician Diploma and are fully eligible to continue to a Bachelor&apos;s degree at AzTU or other accredited universities, benefiting from credit transfer arrangements designed to streamline progression.
                                </p>
                            </div>
                        </SectionBlock>
                    </motion.div>
                    ...
                    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="mb-12">
                        <SectionBlock accent title="Admissions">
                            <ul className="flex flex-col gap-2 text-sm text-gray-600 dark:text-gray-300">
                                {[
                                    "Open to graduates of general secondary education (11 years)",
                                    "Admission based on State Examination Centre (DİM) scores",
                                    "Enrolment takes place once per year, in September",
                                    "Full-time study only; dormitory accommodation available",
                                    "Contact: admissions@btk.edu.az",
                                ].map((item, i) => (
