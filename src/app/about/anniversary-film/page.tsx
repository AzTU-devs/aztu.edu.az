...
export default function AnniversaryFilmPage() {
        ...
        <main className="min-h-screen bg-[#f8fafc] dark:bg-[#0f172a] selection:bg-[#ee7c7e]/30">
            ...
            <div className="relative min-h-[70vh] flex flex-col pt-44 lg:pt-48">
                ...
                <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                    ...
                    <div className="absolute top-0 right-0 w-full lg:w-[85%] h-full bg-gradient-to-br from-[#ee7c7e] to-[#1a2355] opacity-20 blur-3xl animate-pulse" />
                    ...
                    <div className="flex-1 flex flex-col justify-center">
                        <div className="max-w-4xl">
                            ...
                            >
                                ...
                                <p className="text-xl lg:text-3xl text-white font-medium mb-10 max-w-3xl leading-relaxed">
                                    {p.subtitle}
                                </p>
                            </motion.div>
                        </div>
            ...
            {/* VIDEO SECTION */}
            <div className="relative z-20 -mt-24 px-4 md:px-10 lg:px-20 mb-32">
                <motion.div 
                    initial={{ opacity: 0, scale: 0.95 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    viewport={{ once: true }}
                    transition={{ duration: 0.8 }}
                    className="max-w-[1200px] mx-auto aspect-video bg-black rounded-[2.5rem] overflow-hidden shadow-[0_50px_100px_rgba(0,0,0,0.5)] border-4 border-white/10"
                >
                    <iframe
                        className="w-full h-full"
                        src="https://www.youtube.com/embed/GQpGsaA1IgE?autoplay=0&rel=0"
                        title="AzTU 75th Anniversary Film"
