                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                            {p.stats.map((stat: { value: string; label: string }, i: number) => (
                                <div
                                    key={i}
                                    className="p-8 rounded-[1.5rem] bg-[#1a2355] text-white text-center relative overflow-hidden group hover:bg-[#ee7c7e] transition-all duration-500 shadow-xl"
                                >
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {[p.doctoralDuration.phd, p.doctoralDuration.ds].map((prog, i) => (
                                <div key={i} className="p-8 rounded-[1.5rem] bg-[#1a2355] text-white relative overflow-hidden">
