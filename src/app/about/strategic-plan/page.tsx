                ...
                <div className="relative z-10 max-w-[1600px] mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
                        <motion.div 
                            ...
                            viewport={{ once: true }}
                            className="bg-gray-50 dark:bg-white/5 p-10 rounded-[18px] border border-gray-100 dark:border-white/10"
                        >
                    ...
                    <div className="mb-32">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            {p.pillars.map((pillar: any, i: number) => (
                                ...
                                >
                                    <div className="bg-white dark:bg-white/5 p-8 rounded-[18px] border border-gray-100 dark:border-white/10 shadow-sm h-full flex gap-6">
