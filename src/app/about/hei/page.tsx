                ...
                <div className="relative z-10 max-w-[1600px] mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start mb-32">
                        ...
                        >
                            ...
                            {/* Mission Section */}
                            <div className="mt-16 p-8 rounded-[1.75rem] bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-32">
                        ...
                        <motion.div 
                            ...
                            viewport={{ once: true }}
                            className="bg-[#1a2355] rounded-[2rem] p-10 md:p-14 text-white relative overflow-hidden group"
                        >
                        ...
                        <motion.div 
                            ...
                            whileInView={{ opacity: 1, x: 0 }} 
                            viewport={{ once: true }}
                            className="bg-white dark:bg-white/5 rounded-[2rem] p-10 md:p-14 border border-gray-100 dark:border-white/10 shadow-xl relative overflow-hidden group"
                        >
                            <div className="absolute top-0 right-0 p-10 opacity-5 group-hover:opacity-10 transition-opacity">
                    ...
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1, y: 0 }} 
                        viewport={{ once: true }}
                        className="bg-gray-50 dark:bg-white/5 rounded-[2rem] p-10 md:p-16 border border-gray-100 dark:border-white/10 mb-32"
                    >
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                            ...
                            <div className="lg:col-span-5 space-y-8">
                                <div className="p-8 rounded-[1.5rem] bg-[#ee7c7e] text-white shadow-xl shadow-[#ee7c7e]/20">
                                ...
                                <div className="p-8 rounded-[1.5rem] bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10">
                    ...
                    <div className="space-y-32">
                        ...
                        {/* Management Board */}
                        <section className="bg-slate-50 dark:bg-white/5 rounded-[2.5rem] p-10 md:p-20 relative overflow-hidden border border-slate-100 dark:border-white/10">
                                ...
                                <div className="mt-20 pt-16 border-t border-slate-200 dark:border-white/10">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                        {p.board.requirements.map((req: string, i: number) => (
                                            <div key={i} className="p-8 rounded-[1.75rem] bg-white dark:bg-white/5 border border-slate-100 dark:border-white/10 text-sm text-gray-500 dark:text-gray-400 leading-relaxed shadow-sm">
                                                {req}
                                            </div>
                                        ))}
                                    </div>
                                    <div className="mt-16 text-center">
                                        <div className="inline-block p-8 rounded-[1.5rem] bg-[#1a2355] text-white">
                    ...
                    <div className="pt-20 mt-32 border-t border-gray-100 dark:border-white/10">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            {p.related.map((link: any) => (
                                <Link key={link.href} href={link.href} className="group flex items-center justify-between bg-white dark:bg-white/5 p-6 rounded-[1.25rem] border border-gray-100 dark:border-white/10 hover:border-[#1a2355] dark:hover:border-[#ee7c7e] transition-all duration-300 shadow-sm hover:shadow-xl">
