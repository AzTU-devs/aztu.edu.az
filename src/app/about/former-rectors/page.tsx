        ...
        <main className="relative min-h-screen selection:bg-[#ee7c7e]/30 overflow-hidden">
            ...
            <div className="relative px-4 md:px-10 lg:px-20 py-24 z-10">
                <div className="max-w-[1400px] mx-auto">
                    {p.rectors.length === 0 ? (
                        <div className="rounded-[1.5rem] border border-[#1a2355]/15 dark:border-white/10 bg-white/70 dark:bg-slate-900/60 backdrop-blur-xl p-12 text-center">
