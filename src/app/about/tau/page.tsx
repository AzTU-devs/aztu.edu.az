                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
                        {p.facts.map((f: any, i: number) => (
                            <motion.div 
                                ...
                                className="bg-gray-50 dark:bg-white/5 p-8 rounded-[1.5rem] border border-gray-100 dark:border-white/10 hover:border-[#ee7c7e]/30 transition-all duration-300 shadow-sm"
                            >
                            ...
                            {p.websiteUrl && (
                                <div className="mt-12">
                                    <a 
                                        ...
                                        className="inline-flex items-center gap-4 bg-[#1a2355] text-white px-8 py-4 rounded-[1.25rem] font-black uppercase tracking-widest text-xs hover:bg-[#ee7c7e] transition-all shadow-xl shadow-[#1a2355]/20 group"
                                    >
