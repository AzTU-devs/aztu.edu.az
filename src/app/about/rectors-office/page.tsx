    ...
    return (
        <main className="relative min-h-screen selection:bg-[#ee7c7e]/30 overflow-hidden">
                ...
                <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-[0.35em] text-[#1a2355] dark:text-white/60">
                    ...
                    <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-5">
                        {responsibilities.map((r, i) => (
                            <motion.div
                                ...
                                className="group relative bg-white/80 dark:bg-slate-900/60 backdrop-blur-xl rounded-[1.375rem] p-6 border border-[#1a2355]/15 dark:border-white/10 hover:border-[#ee7c7e]/40 hover:-translate-y-1 transition-all duration-500 overflow-hidden"
                            >
                        ...
                        <motion.div
                            ...
                            className="relative bg-[#1a2355] text-white rounded-[1.375rem] p-6 overflow-hidden"
                        >
                            <div className="absolute -top-12 -right-12 w-44 h-44 bg-[#ee7c7e]/30 blur-3xl rounded-full" />
                            <div className="relative z-10 h-full flex flex-col justify-between gap-6">
                                <div>
                                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-[#ee7c7e] mb-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {p.staff.map((member: StaffMember, i: number) => (
                            <motion.article
                                ...
                                className="group relative bg-white/85 dark:bg-slate-900/70 backdrop-blur-xl rounded-[1.5rem] border border-[#1a2355]/15 dark:border-white/10 hover:border-[#ee7c7e]/40 hover:shadow-2xl hover:shadow-[#1a2355]/10 transition-all duration-500 overflow-hidden flex flex-col sm:flex-row"
                            >
                                {/* Left: photo */}
                                ...
                                <div className="flex-1 p-6 lg:p-8 flex flex-col justify-between gap-6">
                                    <div>
                                        <p className="text-[10px] uppercase tracking-[0.3em] text-[#ee7c7e] font-black mb-2">
                                            {member.title}
                                        </p>
            ...
            <section className="relative px-4 md:px-10 lg:px-20 py-16 z-10">
                <div className="max-w-[1400px] mx-auto">
                    <div className="relative bg-[#1a2355] rounded-[1.75rem] p-8 lg:p-12 overflow-hidden text-white">
