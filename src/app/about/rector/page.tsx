        ...
        <div className="relative w-full overflow-hidden py-10">
            ...
            >
                {doubledItems.map((item, idx) => (
                    <div 
                        key={idx}
                        className="relative w-80 md:w-96 aspect-[4/3] rounded-[1.5rem] overflow-hidden border-2 border-[#1a2355]/30 dark:border-white/10 shadow-lg group hover:scale-[1.02] transition-transform duration-500"
                    >
                        <Image
                            src={item.image}
                            alt="Rector Activity"
                ...
                <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-5 order-1 lg:order-2">
                        ...
                        >
                            ...
                            <div className="relative w-full h-full rounded-[1.75rem] overflow-hidden shadow-2xl z-10 border border-white/10">
                                <Image
                                    src={VilayetVeliyev}
                                    alt={fullName}
                                    fill
            ...
            <PageContainer className="space-y-32">
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
                        ...
                        <div className="lg:col-span-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl p-10 rounded-[2rem] border-2 border-[#1a2355]/30 dark:border-white/10 shadow-xl relative overflow-hidden">
                ...
                <section className="bg-[#1a2355] rounded-[2.5rem] p-10 md:p-20 text-white relative overflow-hidden shadow-2xl border-4 border-white/5">
                    ...
                    <div className="relative z-10">
                        <div className="flex flex-col md:flex-row md:items-end justify-between gap-10 mb-20">
                            ...
                            <div className="flex items-center gap-4 px-8 py-5 rounded-[1.5rem] bg-white/10 border border-white/20 backdrop-blur-xl">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {p.departments.map((dept, i) => (
                                <motion.div
                                    ...
                                    className="group flex items-center gap-5 p-6 rounded-[1.5rem] bg-white/5 border border-white/10 hover:bg-[#ee7c7e] hover:border-[#ee7c7e] transition-all duration-500 hover:-translate-y-1"
                                >
