                        ...
                        {p.viceRectors.map((vr, i) => (
                            ...
                            >
                                <Link
                                    ...
                                    className="group relative flex flex-col h-full bg-white/80 dark:bg-slate-900/60 backdrop-blur-xl rounded-[12px] border-2 border-[#1a2355]/20 dark:border-white/10 p-6 transition-all duration-500 hover:-translate-y-2 hover:border-[#ee7c7e] hover:shadow-2xl hover:shadow-[#1a2355]/20 overflow-hidden"
                                >
                                    {/* Decorative blur */}
