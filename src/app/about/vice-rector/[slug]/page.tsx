                ...
                <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-5 order-1 lg:order-2">
                        ...
                        >
                            ...
                            <div className="relative w-full h-full rounded-[2.5rem] overflow-hidden shadow-2xl z-10 border border-white/10 bg-gradient-to-br from-[#1a2355] to-[#0f172a] flex items-center justify-center">
                                {vr.photoUrl ? (
                ...
                <section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                        ...
                        <div className="lg:col-span-4 space-y-6 lg:sticky lg:top-28">
                            <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl p-8 rounded-[2.5rem] border-2 border-[#1a2355]/30 dark:border-white/10 shadow-xl relative overflow-hidden">
                            ...
                            <div className="bg-[#1a2355] p-8 rounded-[2.5rem] text-white shadow-xl relative overflow-hidden">
