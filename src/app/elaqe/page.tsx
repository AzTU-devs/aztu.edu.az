        ...
        <main className="relative min-h-screen selection:bg-[#ee7c7e]/30 overflow-hidden">
            ...
            <PageContainer>
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 relative z-10">
                    ...
                    >
                        <div className="sticky top-28 relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#0b1330] via-[#1a2355] to-[#13365E] p-10 md:p-12 text-white shadow-2xl border-2 border-white/10">
                    ...
                    >
                        <div className="relative overflow-hidden bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-[2rem] border-2 border-[#1a2355]/30 dark:border-[#1a2355]/30 p-10 md:p-14 shadow-2xl shadow-blue-900/5">
                ...
                >
                    ...
                    <div className="relative rounded-[2rem] overflow-hidden border-2 border-[#1a2355]/30 dark:border-[#1a2355]/30 shadow-2xl shadow-blue-900/10 h-[450px] md:h-[520px]">
                        <iframe
                            title="AzTU Map"
