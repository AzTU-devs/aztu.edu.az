    ...
    return (
        <main className="relative min-h-screen selection:bg-[#ee7c7e]/30 overflow-hidden pb-32">
            ...
            <div className="sticky top-[84px] lg:top-4 z-30 mx-4 md:mx-10 lg:mx-20 -mt-8">
                <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-2 border-[#1a2355]/30 dark:border-white/10 p-2.5 rounded-[1.75rem] shadow-2xl shadow-black/5 flex items-center gap-2 overflow-x-auto no-scrollbar scrollbar-hide max-w-[1600px] mx-auto">
                    <button
                        onClick={() => setActiveCategoryId(ALL_CATEGORY_ID)}
                        className={`flex-shrink-0 px-8 py-3.5 rounded-[1.375rem] font-black text-[10px] uppercase tracking-[0.2em] transition-all duration-500 cursor-pointer ${activeCategoryId === ALL_CATEGORY_ID
                    ...
                    {categories.map((cat) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex-shrink-0 px-8 py-3.5 rounded-[1.375rem] font-black text-[10px] uppercase tracking-[0.2em] transition-all duration-500 cursor-pointer ${active
                                        ? "bg-[#1a2355] text-white shadow-xl"
                                        : "text-[#1a2355] dark:text-white/60 hover:bg-[#1a2355]/5 dark:hover:bg-white/5"
                                    }`}
                            >
                ...
                {featured && !listLoading && (
                    ...
                    >
                        <Link href={`/news/${newsSlug(featured.news_id, featured.title)}`}>
                            <div className="group relative bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-[2.5rem] shadow-2xl shadow-blue-900/5 border-2 border-[#1a2355]/30 dark:border-white/10 overflow-hidden flex flex-col lg:flex-row hover:border-[#ee7c7e]/30 transition-all duration-700">
                    ...
                    {rest.map((item, i) => (
                        ...
                        >
                            <Link href={`/news/${newsSlug(item.news_id, item.title)}`} className="group block h-full">
                                <div className="relative bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-[2rem] shadow-2xl shadow-blue-900/5 border-2 border-[#1a2355]/30 dark:border-white/10 overflow-hidden flex flex-col h-full hover:border-[#ee7c7e]/30 transition-all duration-700 hover:-translate-y-2">
                ...
                {list.length < listTotal && (
                    <div className="mt-24 flex justify-center">
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="group px-12 py-5 bg-[#1a2355] text-white rounded-[1.5rem] font-black uppercase text-xs tracking-[0.3em] shadow-2xl shadow-blue-900/40 hover:bg-[#ee7c7e] hover:shadow-red-900/40 transition-all duration-500 flex items-center gap-4 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {listLoading ? (
