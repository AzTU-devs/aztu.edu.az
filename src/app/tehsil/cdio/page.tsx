                ...
                <div className="mb-16">
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                className={`${dark ? "text-white" : "text-[#1a2355] dark:text-white"} text-[11px] font-black uppercase tracking-[0.4em]`}
                            >
                                {badge}
                            </span>
                        </div>
            ...
            >
                <div className="space-y-6">
                    {data.whatIsCdio.paragraphs.map((para, i) => (
                        <div
                            key={i}
                            className="p-8 md:p-10 rounded-[1.75rem] border border-white/10 bg-white/5 backdrop-blur-xl shadow-xl"
                        >
            ...
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {data.institutes.items.map((item, i) => (
                        <div
                            key={i}
                            className="group p-8 rounded-[1.75rem] bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/10 shadow-xl hover:-translate-y-2 hover:border-[#ee7c7e] hover:shadow-[#ee7c7e]/20 transition-all duration-500 relative overflow-hidden"
                        >
            ...
            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {data.studentSociety.objectives.map((obj, i) => (
                        <div
                            key={i}
                            className="flex items-start gap-5 p-8 rounded-[1.75rem] border border-white/10 bg-white/5 backdrop-blur-xl shadow-xl group hover:border-[#ee7c7e]/50 transition-all duration-500"
                        >
            ...
            <section className="px-4 md:px-10 lg:px-20 py-24 bg-gray-50 dark:bg-[#0a0c1a]">
                <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                    {[
                        ...
                        <div
                            key={i}
                            className="p-10 rounded-[2rem] bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 shadow-2xl relative overflow-hidden group hover:-translate-y-2 transition-all duration-500"
                        >
