    ...
    return (
        <main className="min-h-screen bg-page transition-colors duration-500">
                         ...
                         <div className="relative aspect-video rounded-[18px] overflow-hidden border border-gray-100 dark:border-white/10 shadow-2xl">
                            <div className="absolute inset-0 bg-gradient-to-br from-[#1a2355] to-[#0b1330] flex items-center justify-center">
                                ...
                                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-12">
                                     ...
                                     <h3 className="text-white text-3xl font-black tracking-tighter">Smart Learning</h3>
            ...
            <HomeStyleSection 
                ...
                watermark="Rules"
            >
                <div className="p-10 md:p-16 rounded-[18px] border border-white/10 bg-white/5 backdrop-blur-xl flex flex-col md:flex-row items-center justify-between gap-10 shadow-2xl">
                    <div className="flex items-center gap-8">
                        <div className="w-20 h-20 rounded-[18px] bg-[#ee7c7e] flex items-center justify-center text-white shadow-[0_0_30px_rgba(238,124,126,0.3)]">
                            <PictureAsPdfIcon sx={{ fontSize: 40 }} />
                        </div>
                        <div>
                            <h3 className="text-white text-3xl font-black tracking-tighter mb-2">{data.guidelinesTitle}</h3>
                    ...
                    <a 
                        ...
                        className="px-12 py-6 bg-white text-[#1a2355] rounded-[18px] font-black uppercase text-[12px] tracking-[0.12em] hover:bg-[#ee7c7e] hover:text-white transition-all duration-500 shadow-2xl hover:shadow-[#ee7c7e]/40 hover:-translate-y-1"
                    >
            ...
            >
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    <div className="lg:col-span-7">
                        <div className="p-10 md:p-16 rounded-[18px] bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 shadow-2xl h-full flex flex-col justify-center">
                    ...
                    <div className="lg:col-span-5">
                         <div className="p-10 rounded-[18px] bg-[#1a2355] text-white shadow-2xl relative overflow-hidden h-full group hover:shadow-[#ee7c7e]/20 transition-all duration-500">
                             ...
                             <div className="relative z-10">
                                ...
                                <a 
                                    ...
                                    target="_blank" 
                                    rel="noopener noreferrer"
                                    className="w-full flex items-center justify-center gap-4 px-8 py-6 bg-[#ee7c7e] text-white rounded-[22px] font-black uppercase text-[12px] tracking-[0.12em] hover:bg-white hover:text-[#ee7c7e] transition-all duration-500 shadow-2xl shadow-[#ee7c7e]/30"
                                >
                                    <PictureAsPdfIcon />
            ...
            <section className="px-4 md:px-10 lg:px-20 py-24 bg-gray-50 dark:bg-[#070b1a]">
                <div className="max-w-[1600px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="p-10 rounded-[18px] bg-white dark:bg-white/5 border border-gray-100 dark:border-white/10 shadow-2xl relative overflow-hidden group hover:-translate-y-2 transition-all duration-500">
