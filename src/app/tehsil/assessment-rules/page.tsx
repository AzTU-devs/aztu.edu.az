        ...
        <main className="min-h-screen transition-colors duration-500 bg-page dark:bg-[#0a0c1a]">
            ...
            <PageContainer>
                ...
                <motion.section 
                    ...
                    viewport={{ once: true }}
                    className="mb-20 p-8 md:p-12 rounded-[2rem] bg-white dark:bg-slate-800/50 backdrop-blur-md border border-gray-100 dark:border-white/10 shadow-2xl shadow-blue-900/5 flex flex-col md:flex-row items-center justify-between gap-8"
                >
                    ...
                    <a 
                        ...
                        className="group flex items-center gap-4 px-10 py-5 bg-[#1a2355] text-white rounded-[1.5rem] font-black uppercase text-[12px] tracking-[0.2em] hover:bg-[#ee7c7e] transition-all duration-500 shadow-2xl shadow-[#1a2355]/20 hover:shadow-[#ee7c7e]/40"
                    >
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-20">
                    {data.sections.map((section: any, idx: number) => (
                        <motion.section 
                            ...
                            className="flex flex-col h-full bg-white dark:bg-slate-800/40 backdrop-blur-md rounded-[2rem] border border-gray-100 dark:border-white/10 p-8 md:p-10 shadow-2xl shadow-blue-900/5 hover:border-[#ee7c7e]/30 transition-all duration-500"
                        >
                ...
                <section className="pt-32 grid grid-cols-1 md:grid-cols-3 gap-8">
                    <motion.div 
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        className="p-10 rounded-[2rem] bg-[#1a2355] text-white shadow-2xl relative overflow-hidden group"
                    >
                    ...
                    <motion.div 
                        ...
                        className="p-10 rounded-[2rem] bg-white dark:bg-slate-800/40 border border-gray-100 dark:border-white/10 shadow-2xl relative overflow-hidden group"
                    >
