                ...
                {loading ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                        {[1, 2, 3, 4, 5, 6, 7, 8].map(i => (
                            <div key={i} className="h-80 rounded-[2rem] bg-white/80 dark:bg-slate-800/50 backdrop-blur-xl animate-pulse border-2 border-[#1a2355]/30 dark:border-white/10" />
                        ))}
                    </div>
                ) : projects.length === 0 ? (
                    <div className="text-center py-40 bg-white/80 dark:bg-slate-800/50 backdrop-blur-xl rounded-[2.5rem] border-2 border-dashed border-[#1a2355]/20 dark:border-white/10 relative z-10">
                            ...
                            return (
                                ...
                                >
                                    <Link href={`/projects/${project.project_id}`} className="group block h-full">
                                        <div className="relative h-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-[2rem] shadow-2xl shadow-blue-900/5 border-2 border-[#1a2355]/30 dark:border-white/5 p-10 transition-all duration-700 overflow-hidden hover:-translate-y-2 hover:border-[#ee7c7e]/30">
                                            {/* Decorative Background */}
                                            <div className="absolute top-0 right-0 w-32 h-32 bg-[#1a2355]/5 dark:bg-white/5 rounded-bl-[3rem] -mr-8 -mt-8 transition-transform duration-700 group-hover:scale-110" />
