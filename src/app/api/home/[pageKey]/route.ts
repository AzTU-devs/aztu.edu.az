...
/**
 * Server-side proxy for the Home CMS payload.
 *
...
export async function GET(
    ...
    try {
        ...
        const upstream = await fetch(
            `${API_BASE.replace(/\/$/, "")}/api/home/public/pages/${pageKey}?lang=${lang}`,
            {
                headers,
        ...
        console.error(`[home] upstream fetch failed for "${pageKey}":`, error);
        return Response.json(
