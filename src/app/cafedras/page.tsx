...
import { CafedraInterface, getCafedras } from "@/services/cafedraService/cafedraService";
        ...
        <>
            ...
            <main className="min-h-screen">
                ...
                <div className="bg-[#1a2355] px-4 md:px-10 lg:px-20 py-16">
                    <h1 className="text-3xl md:text-4xl font-bold text-white mb-2">Departments (Cafedras)</h1>
                    <p className="text-white/70 text-base">
                        Browse all academic departments at Azerbaijan Technical University.
                    </p>
                </div>
