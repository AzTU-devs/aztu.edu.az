  ...
  pages: {
    community: {
      ...
      honoraryGraduates: {
        ...
        graduates: [
          { name: "Samir Nuriyev", description: "Head of the Administration of the President of the Republic of Azerbaijan." },
          { name: "Beyler Eyyubov", description: "Head of the Secretariat of the President of the Republic of Azerbaijan." },
          { name: "Yagub Eyyubov", description: "First Deputy Prime Minister of the Republic of Azerbaijan." },
          { name: "Ahmad Ahmadzada", description: "Assistant to the Prime Minister of the Republic of Azerbaijan." },
          { name: "Zahid Oruj", description: "Member of the Milli Majlis." },
          { name: "Mikhail Zabelin", description: "Member of the Milli Majlis." },
          { name: "Taleh Kazimov", description: "Governor of the Central Bank of the Republic of Azerbaijan." },
          { name: "Rasim Alguliyev", description: "Vice-President of ANAS, director-general of the Institute of Information Technology." },
          { name: "Araz Agalarov", description: "Vice-President of the All-Russian Azerbaijani Congress." },
          { name: "Hasan Hasanov", description: "A prominent public, state and political figure, diplomat, the former Minister of Foreign Affairs of Azerbaijan." },
          { name: "Abid Sharifov", description: "Deputy Prime Minister of Azerbaijan from 1995 to 2018." },
          { name: "Agacan Abiyev", description: "Member of the Milli Majlis (2005, 2010, 2015). Rector of the Azerbaijan State Academy of Physical Education and Sports (1987 – 2015)." },
          { name: "Vahid Ahmadov", description: "Member of the Milli Majlis (2005, 2010, 2015, 2020)." },
          { name: "Havar Mammadov", description: "Former rector of Baku Engineering University." },
          { name: "Tagi Ahmadov", description: "Former head of Baku Metro." },
          { name: "Vagif Hasanov", description: "Head of the department of energy efficiency and green energy technologies at AzTU." },
          { name: "Magsud Ibrahimbeyov", description: "Azerbaijani writer, prose writer, screenwriter, and director." },
          { name: "Kamran Bagirov", description: "Chairman of the Azerbaijan State Committee for Supervision of Safe Work in Industry and Mining Supervision (1991–1992)." },
          { name: "Hasan Seidov", description: "Chairman of the Council of Ministers of the Azerbaijan SSR." },
          { name: "Rafig Xalafov", description: "Deputy Prime Minister of the Republic of Azerbaijan (1997-1998)." },
          { name: "Fuad Musayev", description: "Former President of the Association of Football Federations of Azerbaijan." },
          { name: "Mursal Babayev", description: "Minister of Motor Transport of the Azerbaijan SSR (1970–1979)." },
          { name: "Aydin Mammadov", description: "Director General of the \"Azerbxarijitijaret\" Union of the Ministry of Foreign Economic Relations of the Republic of Azerbaijan (1994)." },
          { name: "Shair Hasanov", description: "Chairman of the Committee on Construction and Architecture of the Republic of Azerbaijan (2001-2006)." },
          { name: "Aliaga Huseynov", description: "Former Member of Parliament." },
          { name: "Ramiz Mirzayev", description: "Former President of AFFA." },
          { name: "Hikmat Aliyev", description: "Head of the department of Electrical Engineering at AzTU." },
          { name: "Shaban Ceerchiyev", description: "Director of the Baku State Vocational Education Center for Industry and Innovation." },
          { name: "Shamil Aliyev", description: "Deputy Director of Baku DOST Center No. 2." },
          { name: "Jeyhun Aslanov", description: "Head of the Rolling Stock Repair Department of \"Azerbaijan Railways\" CJSC." },
          { name: "Emil Nabiyev", description: "Department Head of \"Baku Food and Oil Factory\" LLC." },
          { name: "Farhad Rajabov", description: "Founder of \"FAST SOLUTION\" LLC." },
          { name: "Fatima Karimli (Murshudova)", description: "Deputy Director of \"Hedef Stars Campus\"." },
          { name: "Elshan Bagirov", description: "Head of Department at \"DataLead Consulting\"." },
          { name: "Samir Gadirov", description: "Community Leader at SABAH.HUB Innovation Center." },
          { name: "Mikail Abbasov", description: "Director of the Georgian branch of \"Azerbaijan Railways\" CJSC." },
          { name: "Togrul Pashayev", description: "CEO of SR Group of Companies." },
          { name: "Muslum Samadov", description: "Chief Engineer at Aselsan Baku LLC." },
          { name: "Zeynal Karimzade", description: "Founder and CEO of Epoint Inc." },
          { name: "Xaqani Farajov", description: "Director of the Specialized Olympic Reserve Children's and Youth Gymnastics School." },
          { name: "Elchin Mammadov", description: "Deputy Head of the Cargo Transportation Department of \"Azerbaijan Railways\" CJSC." },
          { name: "Elmar Mammadov", description: "Head of the Bash Alat station of the Freight Transportation Department of \"Azerbaijan Railways\" CJSC." },
          { name: "Aydin Bayramov", description: "Head of the Rolling Shop at Baku Steel Company CJSC." },
          { name: "Sabuhi Zarbaliyev", description: "Director of Sales Department of \"Maxinet\" LLC." },
          { name: "Mardan Aliyev", description: "Director of \"EL METAL PLUS\" CJSC." },
          { name: "Sabir Kamilli", description: "Field Chief at \"EL METAL PLUS\" CJSC." },
          { name: "Kamal Hasanov", description: "Head of Quality Department at \"EL METAL PLUS\" CJSC." },
          { name: "Nurlan Kərimov", description: "Head of Department of the T. Ismayilov Institute for Space Research of Natural Resources." },
          { name: "İmran Yolchuyev", description: "Associate Professor of AzTU." },
        ],
      },
      ourHeroes: {
        eyebrow: "AzTU's Honors",
