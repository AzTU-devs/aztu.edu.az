  ...
  pages: {
    community: {
      ...
      honoraryGraduates: {
        ...
        graduates: [
          { name: "Samir Nuriyev", description: "Azərbaycan Respublikası Prezidentinin Administrasiyasının rəhbəri." },
          { name: "Beyler Eyyubov", description: "Azərbaycan Respublikası Prezidentinin Mühafizə Xidmətinin rəisi." },
          { name: "Yaqub Eyyubov", description: "Azərbaycan Respublikasının Baş nazirinin birinci müavini." },
          { name: "Əhməd Əhmədzadə", description: "Azərbaycan Respublikasının Baş nazirinin köməkçisi." },
          { name: "Zahid Oruc", description: "Milli Məclisin üzvü." },
          { name: "Mixail Zabelin", description: "Milli Məclisin üzvü." },
          { name: "Taleh Kazımov", description: "Azərbaycan Respublikası Mərkəzi Bankının sədri." },
          { name: "Rasim Əliquliyev", description: "AMEA-nın vitse-prezidenti, İnformasiya Texnologiyaları İnstitutunun baş direktoru." },
          { name: "Araz Ağalarov", description: "Ümumrusiya Azərbaycanlıları Konqresinin vitse-prezidenti." },
          { name: "Həsən Həsənov", description: "Görkəmli ictimai, dövlət və siyasi xadim, diplomat, Azərbaycanın sabiq xarici işlər naziri." },
          { name: "Abid Şərifov", description: "1995-2018-ci illərdə Azərbaycan Respublikasının Baş nazirinin müavini." },
          { name: "Ağacan Abıyev", description: "Milli Məclisin üzvü (2005, 2010, 2015). Azərbaycan Dövlət Bədən Tərbiyəsi və İdman Akademiyasının rektoru (1987 – 2015)." },
          { name: "Vahid Əhmədov", description: "Milli Məclisin üzvü (2005, 2010, 2015, 2020)." },
          { name: "Havar Məmmədov", description: "Bakı Mühəndislik Universitetinin keçmiş rektoru." },
          { name: "Tağı Əhmədov", description: "Bakı Metropoliteninin keçmiş rəhbəri." },
          { name: "Vaqif Həsənov", description: "AzTU-nun Enerji Səmərəliliyi və Yaşıl Enerji Texnologiyaları kafedrasının müdiri." },
          { name: "Maqsud İbrahimbəyov", description: "Azərbaycan yazıçısı, nasir, ssenarist və rejissor." },
          { name: "Kamran Bağırov", description: "Azərbaycan Respublikası Sənaye və Mədən Nəzarəti üzrə Təhlükəsiz İşlərin Nəzarəti Dövlət Komitəsinin sədri (1991–1992)." },
          { name: "Həsən Seyidov", description: "Azərbaycan SSR Nazirlər Sovetinin sədri." },
          { name: "Rafiq Xələfov", description: "Azərbaycan Respublikasının Baş nazirinin müavini (1997-1998)." },
          { name: "Fuad Musayev", description: "Azərbaycan Futbol Federasiyaları Assosiasiyasının keçmiş prezidenti." },
          { name: "Mürsəl Babayev", description: "Azərbaycan SSR Avtomobil Nəqliyyatı naziri (1970–1979)." },
          { name: "Aydın Məmmədov", description: "Azərbaycan Respublikası Xarici İqtisadi Əlaqələr Nazirliyinin \"Azərbxariciticarət\" Birliyinin baş direktoru (1994)." },
          { name: "Şair Həsənov", description: "Azərbaycan Respublikasının Tikinti və Memarlıq Komitəsinin sədri (2001-2006)." },
          { name: "Əliağa Hüseynov", description: "Sabiq Milli Məclis üzvü." },
          { name: "Ramiz Mirzəyev", description: "AFFA-nın sabiq prezidenti." },
          { name: "Hikmət Əliyev", description: "AzTU-nun Elektrotexnika kafedrasının müdiri." },
          { name: "Şaban Ceyirçiyev", description: "Bakı Şəhər Sənaye və İnnovasiya üzrə Peşə Təhsil Mərkəzinin direktoru." },
          { name: "Şamil Əliyev", description: "Bakı DOST Mərkəzi № 2-nin direktor müavini." },
          { name: "Ceyhun Aslanov", description: "\"Azərbaycan Dəmir Yolları\" QSC Lokomotiv Təmiri Departamentinin rəhbəri." },
          { name: "Emil Nəbiyev", description: "\"Baku Food and Oil Factory\" MMC-nin Departament rəhbəri." },
          { name: "Fərhad Rəcəbov", description: "\"FAST SOLUTION\" MMC-nin təsisçisi." },
          { name: "Fatimə Kərimli (Murşudova)", description: "\"Hədəf Stars Campus\"-un direktor müavini." },
          { name: "Elşən Bağırov", description: "\"DataLead Consulting\"-də Şöbə rəhbəri." },
          { name: "Samir Qədirov", description: "SABAH.HUB İnnovasiya Mərkəzinin İcma Lideri." },
          { name: "Mikayıl Abbasov", description: "\"Azərbaycan Dəmir Yolları\" QSC Gürcüstan filialının direktoru." },
          { name: "Toğrul Paşayev", description: "SR Group şirkətlər qrupunun baş icraçı direktoru." },
          { name: "Müslüm Səmədov", description: "Aselsan Baku MMC-nin baş mühəndisi." },
          { name: "Zeynal Kərimzadə", description: "Epoint Inc.-in təsisçisi və baş icraçı direktoru." },
          { name: "Xaqani Fərəcov", description: "İxtisaslaşmış Olimpiya Ehtiyat Uşaq və Gənclər Gimnastika Məktəbinin direktoru." },
          { name: "Elçin Məmmədov", description: "\"Azərbaycan Dəmir Yolları\" QSC Yük Daşıma Departamentinin rəis müavini." },
          { name: "Elmar Məmmədov", description: "\"Azərbaycan Dəmir Yolları\" QSC Yük Daşıma Departamentinin Baş Ələt stansiyasının rəhbəri." },
          { name: "Aydın Bayramov", description: "Baku Steel Company QSC-də Yayma Sexinin rəhbəri." },
          { name: "Səbuhi Zərbəliyev", description: "\"Maxinet\" MMC-nin Satış Departamentinin direktoru." },
          { name: "Mərdan Əliyev", description: "\"EL METAL PLUS\" QSC-nin direktoru." },
          { name: "Sabir Kamilli", description: "\"EL METAL PLUS\" QSC-nin Sahə rəisi." },
          { name: "Kamal Həsənov", description: "\"EL METAL PLUS\" QSC-nin Keyfiyyət şöbəsinin rəhbəri." },
          { name: "Nurlan Kərimov", description: "T. İsmayılov adına Təbii Ehtiyatların Kosmik Tədqiqi İnstitutunun Şöbə rəhbəri." },
          { name: "İmran Yolçuyev", description: "AzTU-nun dosenti." },
        ],
      },
      ourHeroes: {
        eyebrow: "AzTU-nun Fəxriləri",
