  ...
  pages: {
    about: {
      ...
      rector: {
        ...
        galleryItems: [
          { caption: "Yeni tədqiqat laboratoriyasının açılış mərasimi, 2024" },
          { caption: "AzTU-da beynəlxalq tərəfdaşlarla görüş, 2024" },
          { caption: "2024-cü il məzunlarının buraxılış mərasimi" },
          { caption: "Bakı Dövlət Universiteti ilə əməkdaşlıq müqaviləsinin imzalanması" },
          { caption: "STEM Olimpiadası mükafatlandırma mərasimi, 2023" },
          { caption: "Rektorun Akademik Şura iclasındakı çıxışı" },
        ],
      },
