  ...
  pages: {
    community: {
      honoraryDoctors: {
        ...
        doctors: [
          {
            name: "Ersin Tatar (ŞKTC)",
            description: "Şimali Kipr Türk Cümhuriyyətinin Prezidenti.",
            award: "Fəxri Doktor",
            date: "02.07.2025",
            image: "https://aztu.edu.az/sdg/wp-content/uploads/2026/04/aztudoktors.png",
          },
          {
            name: "Səlcuq Bayraktar (Türkiyə)",
            description: "Baykar şirkətinin İdarə Heyətinin Sədri və Baş Texnologiya Direktoru.",
            award: "Fəxri Doktor",
            date: "25.05.2022",
            image: "",
          },
          {
            ...
            description: "Brandenburq Texnologiya Universitetinin Mexanika Mühəndisliyi, Elektrik və Enerji Sistemləri Fakültəsinin Dəzgahlar kafedrasının müdiri, professor (Mexanika Mühəndisliyi).",
            award: "Fəxri Doktor",
            date: "12.06.2019",
            image: "",
          },
          {
            ...
            description: "Iona Kollecinin (Nyu-York) direktoru, professor.",
            award: "Fəxri Doktor",
            date: "28.11.2012",
            image: "",
          },
          {
            ...
            description: "Rostok Universitetinin Texniki Termodinamika kafedrasının müdiri, Mexanika Mühəndisliyi və Gəmi Memarlığı Fakültəsinin dekanı.",
            award: "Fəxri Doktor",
            date: "28.11.2012",
            image: "",
          },
          {
            name: "Hamadun Ture (İsveçrə)",
          ...
          {
            name: "İon İliesku (Rumıniya)",
            description: "Rumıniyalı siyasətçi və dövlət xadimi, 1989-1996 və 2000-2004-cü illərdə Rumıniya Prezidenti.",
            award: "Fəxri Doktor",
            date: "25.10.2002",
            image: "",
          },
          {
            ...
            description: "Maşın Konstruksiyası Əsasları və Kommersiya Nəqliyyat Vasitələri İnstitutunun rəhbəri.",
            award: "Fəxri Doktor",
            date: "30.05.2000",
            image: "",
          },
          {
            name: "Reza Talebi-Daryani (Almaniya)",
            description: "Köln Texnologiya Universitetinin professoru.",
            award: "Fəxri Doktor",
            date: "09.11.1999",
            image: "",
          },
          {
            ...
            description: "Dyuk Universitetində kafedra müdiri.",
            award: "Fəxri Doktor",
            date: "03.05.1999",
            image: "",
          },
          {
            name: "Veytsax Quretski (Polşa)",
            description: "Krakov Dağ-Mədən və Metallurgiya Universitetinin Enerji Məhsulları İnstitutunun direktoru.",
            award: "Fəxri Doktor",
            date: "02.06.1998",
            image: "",
          },
          {
            name: "Şafik Alp Bahadir (Almaniya)",
            description: "FAU Erlangen-Nürnberg Universitetində iqtisadiyyat professoru və Orta Şərq Bölməsinin direktoru.",
            award: "Fəxri Doktor",
            date: "",
            image: "",
          },
          {
            name: "Əli Doğramacı (Türkiyə)",
            description: "Bilkənt Universitetinin rektoru, professor, PhD.",
            award: "Fəxri Doktor",
            date: "31.10.1995",
            image: "",
          },
          {
            ...
            description: "Karlsrue Texnologiya İnstitutunun professoru.",
            award: "Fəxri Doktor",
            date: "31.12.1995",
            image: "",
          },
      ...
      honoraryGraduates: {
        eyebrow: "AzTU-nun Fəxriləri",
        title: "Fəxri Məzunlar",
        subtitle: "Azərbaycan Texniki Universitetinin Fəxri Məzun adı verdiyi tanınmış məzunlar və dəstəkçilər.",
        breadcrumb: "Fəxri Məzunlar",
        graduates: [
          { name: "Samir Nuriyev", description: "Azərbaycan Respublikası Prezidentinin Administrasiyasının rəhbəri.", image: "/honorary-graduates/01.jpg" },
          { name: "Beyler Eyyubov", description: "Azərbaycan Respublikası Prezidentinin Mühafizə Xidmətinin rəisi.", image: "/honorary-graduates/02.jpg" },
          { name: "Yaqub Eyyubov", description: "Azərbaycan Respublikasının Baş nazirinin birinci müavini.", image: "/honorary-graduates/03.jpg" },
          { name: "Əhməd Əhmədzadə", description: "Azərbaycan Respublikasının Baş nazirinin köməkçisi.", image: "/honorary-graduates/04.jpg" },
          { name: "Zahid Oruc", description: "Milli Məclisin üzvü.", image: "/honorary-graduates/05.jpg" },
          { name: "Mixail Zabelin", description: "Milli Məclisin üzvü.", image: "/honorary-graduates/06.jpg" },
          { name: "Taleh Kazımov", description: "Azərbaycan Respublikası Mərkəzi Bankının sədri.", image: "/honorary-graduates/07.jpg" },
          { name: "Rasim Əliquliyev", description: "AMEA-nın vitse-prezidenti, İnformasiya Texnologiyaları İnstitutunun baş direktoru.", image: "/honorary-graduates/08.jpg" },
          { name: "Araz Ağalarov", description: "Ümumrusiya Azərbaycanlıları Konqresinin vitse-prezidenti.", image: "/honorary-graduates/09.jpg" },
          { name: "Həsən Həsənov", description: "Görkəmli ictimai, dövlət və siyasi xadim, diplomat, Azərbaycanın sabiq xarici işlər naziri.", image: "/honorary-graduates/10.jpg" },
          { name: "Abid Şərifov", description: "1995-2018-ci illərdə Azərbaycan Respublikasının Baş nazirinin müavini.", image: "/honorary-graduates/11.jpg" },
          { name: "Ağacan Abıyev", description: "Milli Məclisin üzvü (2005, 2010, 2015). Azərbaycan Dövlət Bədən Tərbiyəsi və İdman Akademiyasının rektoru (1987 – 2015).", image: "/honorary-graduates/12.jpg" },
          { name: "Vahid Əhmədov", description: "Milli Məclisin üzvü (2005, 2010, 2015, 2020).", image: "/honorary-graduates/13.jpg" },
          { name: "Havar Məmmədov", description: "Bakı Mühəndislik Universitetinin keçmiş rektoru.", image: "/honorary-graduates/14.jpg" },
          { name: "Tağı Əhmədov", description: "Bakı Metropoliteninin keçmiş rəhbəri.", image: "/honorary-graduates/15.jpg" },
          { name: "Vaqif Həsənov", description: "AzTU-nun Enerji Səmərəliliyi və Yaşıl Enerji Texnologiyaları kafedrasının müdiri.", image: "/honorary-graduates/16.jpg" },
          { name: "Maqsud İbrahimbəyov", description: "Azərbaycan yazıçısı, nasir, ssenarist və rejissor.", image: "/honorary-graduates/17.jpg" },
          { name: "Kamran Bağırov", description: "Azərbaycan Respublikası Sənaye və Mədən Nəzarəti üzrə Təhlükəsiz İşlərin Nəzarəti Dövlət Komitəsinin sədri (1991–1992).", image: "/honorary-graduates/18.jpg" },
          { name: "Həsən Seyidov", description: "Azərbaycan SSR Nazirlər Sovetinin sədri.", image: "/honorary-graduates/19.jpg" },
          { name: "Rafiq Xələfov", description: "Azərbaycan Respublikasının Baş nazirinin müavini (1997-1998).", image: "/honorary-graduates/20.jpg" },
          { name: "Fuad Musayev", description: "Azərbaycan Futbol Federasiyaları Assosiasiyasının keçmiş prezidenti.", image: "/honorary-graduates/21.jpg" },
          { name: "Mürsəl Babayev", description: "Azərbaycan SSR Avtomobil Nəqliyyatı naziri (1970–1979).", image: "/honorary-graduates/22.jpg" },
          { name: "Aydın Məmmədov", description: "Azərbaycan Respublikası Xarici İqtisadi Əlaqələr Nazirliyinin \"Azərbxariciticarət\" Birliyinin baş direktoru (1994).", image: "/honorary-graduates/23.jpg" },
          { name: "Şair Həsənov", description: "Azərbaycan Respublikasının Tikinti və Memarlıq Komitəsinin sədri (2001-2006).", image: "/honorary-graduates/24.jpg" },
          { name: "Əliağa Hüseynov", description: "Sabiq Milli Məclis üzvü.", image: "/honorary-graduates/25.jpg" },
          { name: "Ramiz Mirzəyev", description: "AFFA-nın sabiq prezidenti.", image: "/honorary-graduates/26.jpg" },
          { name: "Hikmət Əliyev", description: "AzTU-nun Elektrotexnika kafedrasının müdiri.", image: "/honorary-graduates/27.jpg" },
          { name: "Şaban Ceyirçiyev", description: "Bakı Şəhər Sənaye və İnnovasiya üzrə Peşə Təhsil Mərkəzinin direktoru.", image: "/honorary-graduates/28.jpg" },
          { name: "Şamil Əliyev", description: "Bakı DOST Mərkəzi № 2-nin direktor müavini.", image: "/honorary-graduates/29.jpg" },
          { name: "Ceyhun Aslanov", description: "\"Azərbaycan Dəmir Yolları\" QSC Lokomotiv Təmiri Departamentinin rəhbəri.", image: "/honorary-graduates/30.jpg" },
          { name: "Emil Nəbiyev", description: "\"Baku Food and Oil Factory\" MMC-nin Departament rəhbəri.", image: "/honorary-graduates/31.jpg" },
          { name: "Fərhad Rəcəbov", description: "\"FAST SOLUTION\" MMC-nin təsisçisi.", image: "/honorary-graduates/32.jpg" },
          { name: "Fatimə Kərimli (Murşudova)", description: "\"Hədəf Stars Campus\"-un direktor müavini.", image: "/honorary-graduates/33.jpg" },
          { name: "Elşən Bağırov", description: "\"DataLead Consulting\"-də Şöbə rəhbəri.", image: "/honorary-graduates/34.jpg" },
          { name: "Samir Qədirov", description: "SABAH.HUB İnnovasiya Mərkəzinin İcma Lideri.", image: "/honorary-graduates/35.jpg" },
          { name: "Mikayıl Abbasov", description: "\"Azərbaycan Dəmir Yolları\" QSC Gürcüstan filialının direktoru.", image: "/honorary-graduates/36.jpg" },
          { name: "Toğrul Paşayev", description: "SR Group şirkətlər qrupunun baş icraçı direktoru.", image: "/honorary-graduates/37.jpg" },
          { name: "Müslüm Səmədov", description: "Aselsan Baku MMC-nin baş mühəndisi.", image: "/honorary-graduates/38.jpg" },
          { name: "Zeynal Kərimzadə", description: "Epoint Inc.-in təsisçisi və baş icraçı direktoru.", image: "/honorary-graduates/39.jpg" },
          { name: "Xaqani Fərəcov", description: "İxtisaslaşmış Olimpiya Ehtiyat Uşaq və Gənclər Gimnastika Məktəbinin direktoru.", image: "/honorary-graduates/40.jpg" },
          { name: "Elçin Məmmədov", description: "\"Azərbaycan Dəmir Yolları\" QSC Yük Daşıma Departamentinin rəis müavini.", image: "/honorary-graduates/41.jpg" },
          { name: "Elmar Məmmədov", description: "\"Azərbaycan Dəmir Yolları\" QSC Yük Daşıma Departamentinin Baş Ələt stansiyasının rəhbəri.", image: "/honorary-graduates/42.jpg" },
          { name: "Aydın Bayramov", description: "Baku Steel Company QSC-də Yayma Sexinin rəhbəri.", image: "/honorary-graduates/43.jpg" },
          { name: "Səbuhi Zərbəliyev", description: "\"Maxinet\" MMC-nin Satış Departamentinin direktoru.", image: "/honorary-graduates/44.jpg" },
          { name: "Mərdan Əliyev", description: "\"EL METAL PLUS\" QSC-nin direktoru.", image: "/honorary-graduates/45.jpg" },
          { name: "Sabir Kamilli", description: "\"EL METAL PLUS\" QSC-nin Sahə rəisi.", image: "/honorary-graduates/46.jpg" },
          { name: "Kamal Həsənov", description: "\"EL METAL PLUS\" QSC-nin Keyfiyyət şöbəsinin rəhbəri.", image: "/honorary-graduates/47.jpg" },
          { name: "Nurlan Kərimov", description: "T. İsmayılov adına Təbii Ehtiyatların Kosmik Tədqiqi İnstitutunun Şöbə rəhbəri.", image: "/honorary-graduates/48.jpg" },
          { name: "İmran Yolçuyev", description: "AzTU-nun dosenti.", image: "/honorary-graduates/49.jpg" },
        ],
      },
      ourHeroes: {
        eyebrow: "AzTU-nun Fəxriləri",
        ...
        viceRectors: [
          {
            ...
            biography: [
              ...
              "2018–2022-ci illərdə Beynəlxalq əlaqələr üzrə prorektor kimi universitetin qlobal akademik inteqrasiyasının gücləndirilməsinə töhfə vermiş, 2022-ci ildən etibarən Elm və innovasiyalar üzrə prorektor kimi universitetin elmi və innovasiya strategiyasına rəhbərlik etmişdir. 2026-cı ildən etibarən isə Azərbaycan Respublikasının elm və təhsil nazirinin müvafiq əmri ilə Azərbaycan Texniki Universitetinin tədris işləri üzrə prorektoru vəzifəsinə təyin edilmişdir.",
      ...
      exploreProgram: {
        ...
        foreignPrograms: {
          ...
          labels: {
            ...
            viewPlan: "Tədris planına bax",
            planSoon: "Tədris planı tezliklə",
          },
          legend: {
          ...
          faculties: [
            {
              ...
              cycle: "Bakalavr",
              programs: [
                { name: "Kompüter mühəndisliyi", slug: "computer-engineering", english: true, russian: true },
                { name: "Kompüter elmləri", slug: "computer-sciences", english: true, russian: true },
                { name: "İnformasiya texnologiyaları", slug: "information-technologies", english: true, russian: true },
                { name: "İnformasiya təhlükəsizliyi", slug: "information-security", english: true, russian: true },
                { name: "Radiotexnika və telekommunikasiya mühəndisliyi", slug: "radio-telecommunications-engineering", english: true, russian: true },
              ],
            },
            {
              ...
              cycle: "Bakalavr",
              programs: [
                { name: "Maşın mühəndisliyi", slug: "mechanical-engineering", english: false, russian: true },
                { name: "Proseslərin avtomatlaşdırılması mühəndisliyi", slug: "process-automation-engineering", english: false, russian: true },
              ],
            },
            {
              ...
              cycle: "Bakalavr",
              programs: [
                { name: "İqtisadiyyat", slug: "economics", english: true, russian: false },
                { name: "Maliyyə", slug: "finance", english: true, russian: false },
                { name: "Biznesin idarə edilməsi", slug: "business-management", english: true, russian: false },
                { name: "Menecment", slug: "management", english: true, russian: false },
              ],
            },
            {
              ...
              cycle: "Bakalavr",
              programs: [
                { name: "Logistika və nəqliyyat texnologiyaları mühəndisliyi", slug: "logistics-transport-engineering", english: false, russian: true },
              ],
            },
          ],
        },
        studyPlanPage: {
          backToList: "Proqramlara qayıt",
          codeLabel: "Kod",
          courseLabel: "Fənn",
          creditsLabel: "Kredit",
          selectiveLabel: "Seçmə",
          semesterTotalLabel: "Semestr üzrə kredit",
          totalLabel: "Ümumi kredit",
          instructionLanguageLabel: "Tədris dili",
          languages: { en: "İngilis dili", ru: "Rus dili" },
          academicYears: ["1-ci tədris ili", "2-ci tədris ili", "3-cü tədris ili", "4-cü tədris ili"],
          terms: { fall: "Payız semestri", spring: "Yaz semestri" },
          semesterWord: "semestr",
          notFoundTitle: "Tədris planı tapılmadı",
          notFoundText: "Axtardığınız tədris planı mövcud deyil və ya hazırlanır.",
        },
    ...
    fallingWalls: {
      eyebrow: "Beynəlxalq Proqram",
      title: "Falling Walls Lab Azərbaycan",
      subtitle: "Tələbələrdən gənc peşəkarlara qədər istedadlı insanlar üçün cəsarətli, inqilabi ideyaları cəmi üç dəqiqədə bölüşmək platforması.",
      breadcrumb: "Falling Walls Lab",
      about: {
        title: "Falling Walls Lab nədir?",
        paragraphs: [
          "Falling Walls Lab — tələbələrdən tutmuş karyerasının əvvəlindəki peşəkarlara qədər gələcəyin istedadları üçün cəsarətli, inqilabi ideyaları cəmi üç dəqiqədə bölüşmək imkanı verən beynəlxalq bir platformadır.",
          "Bu, sadə bir təqdimat müsabiqəsindən çox daha artığıdır — innovasiya üçün bir startap meydanı, şəbəkə qurmaq üçün mərkəz, interdissiplinar düşüncənin qlobal problemlərlə buluşduğu bir məkandır.",
          "Hər il dünyanın aparıcı universitetləri və qurumları yerli Falling Walls Lab-lar keçirir. İştirakçılara akademiya və sənayedən mütəxəssislərdən ibarət münsiflər heyəti qarşısında innovativ ideyalarını təqdim etmək imkanı yaradılır. Format sürətli, cəlbedici, elmi düşüncə və ünsiyyət bacarıqlarını kəskinləşdirmək üçün nəzərdə tutulmuşdur.",
          "Yerli Lab qaliblərı 6 Noyabr tarixindən Berlindəki qlobal finala vəsiqə qazanır. Orada onlar digər beynəlxalq finalistlərlə \"Emerging Talents\" kateqoriyasında Breakthrough Winner titulu uğrunda yarışır. Finalistlər həmçinin dünyanın ən parlaq zehinlərini bir araya gətirən eksklüziv şəbəkə və öyrənmə təcrübəsi — Falling Walls Science Summit-ə qatılmaq hüququ əldə edir.",
          "Falling Walls Lab Bakı qalibi Science Summit-ə qatılacaq və Almaniyanın Elmi Tədqiqatları Proqramı çərçivəsində 5-11 Noyabr tarixlərində Almaniyada qalacaq.",
        ],
        moreInfo: "Ətraflı məlumat üçün daxil olun:",
        moreInfoLink: "https://falling-walls.com/lab",
      },
      eligibility: {
        title: "İştirak Şərtləri",
        intro: "Falling Walls Lab-lar bütün ixtisaslardan olan tələbələr və karyerasının əvvəlindəki peşəkarlar üçün açıqdır. Müraciətlər yalnız fərdi qaydada qəbul edilir, qrup müraciəti mümkün deyil. Müraciətçilər ərizə verdiyi zaman ən azı 18 yaşında olmalı və aşağıdakı şərtlərdən ən azı birini ödəməlidir:",
        requirements: [
          "Hazırda universitetdə oxuyur",
          "Bakalavr dərəcəsini 10 ildən çox olmayan müddət ərzində almış",
          "Magistr dərəcəsini 7 ildən çox olmayan müddət ərzində almış",
          "Doktorluq dərəcəsini 5 ildən çox olmayan müddət ərzində almış",
        ],
        notesTitle: "Diqqət",
        notes: [
          "Müraciətlər ingilis dilində təqdim edilməlidir.",
          "Falling Walls Lab-da iştirak ömürdə bir dəfə mümkün olan fürsətdir. Əvvəlki iştirakçılar yenidən Lab-a müraciət edə bilmir.",
          "Tibb dərəcəsi (MD, doktorluq dissertasiyası olmadan) magistr dərəcəsinə ekvivalent sayılır. Dr. med. (tibb dərəcəsi, doktorluq dissertasiyası daxil) isə PhD-yə ekvivalent sayılır.",
          "Akademik dərəcələrin qlobal müxtəlifliyi nəzərə alınır.",
        ],
      },
      application: {
        title: "Müraciət Prosesi",
        description: "Müraciətlər Falling Walls veb-saytı vasitəsilə edilir və prosesi 10 dəqiqədən çox çəkmir. Tələb olunan bütün məlumatları doldurun və CV-nizi PDF formatında yükləmə üçün hazır saxlayın. Şərtlər və Qaydaları qəbul edərək müraciəti göndərdikdən sonra müvəffəqiyyətli göndərişi təsdiqləyən bir pəncərə açılacaq, e-poçt ünvanınıza isə təsdiq məktubu göndəriləcək.",
        afterDeadline: "Müraciət müddəti bitdikdən sonra komitə seçim edəcək. Bütün müraciətçilərə nəticə barədə məlumat veriləcək. Seçilmiş iştirakçılara növbəti addımlar haqqında ətraflı məlumat yerli təşkilatçılar tərəfindən çatdırılacaq.",
        linkLabel: "Müraciət Linki",
        link: "https://falling-walls.com/lab/apply",
        linkDisplay: "www.falling-walls.com/lab/apply",
      },
      presentation: {
        title: "Layihə və Təqdimat Tələbləri",
        timeLimitLabel: "Vaxt Limiti",
        timeLimit: "Hər iştirakçı ideyasını üç dəqiqə ərzində təqdim edir.",
        structureTitle: "Təqdimatın Strukturu",
        structureIntro: "Təqdimatçılar həll etdikləri problemi aydın şəkildə ifadə etməli və innovativ həll yollarını izah etməlidirlər. Hər təqdimatçı dörd slayddən istifadə edir:",
        slides: [
          "Ad, qurum və layihə başlığı ilə başlıq slaydı",
          "İki məzmun slaydı",
          "Suallar üçün son slayd",
        ],
        templateNote: "Bütün slaydlar Falling Walls Fondu tərəfindən təqdim olunan rəsmi PowerPoint şablonuna uyğun olmalıdır.",
        guidelinesTitle: "Məzmun Qaydaları",
        guidelines: "Təqdimatlar iltihamlı siyasi və ya dini məzmun ehtiva edə bilməz.",
      },
      sidebar: {
        keyFacts: "Əsas Məlumatlar",
        finaleLabel: "Qlobal Final",
        finaleValue: "6 Noyabr, Berlin",
        tripLabel: "Qalib Səyahəti",
        tripValue: "Almaniya, 5–11 Noyabr",
        durationLabel: "Təqdimat Müddəti",
        durationValue: "3 Dəqiqə",
        slidesLabel: "Tələb Olunan Slaydlar",
        slidesValue: "4 Slayd",
        formatLabel: "Müraciət Forması",
        formatValue: "Yalnız Fərdi",
        languageLabel: "Dil",
        languageValue: "İngilis dili",
        applyButton: "İndi Müraciət Et",
        applyUrl: "https://falling-walls.com/lab/apply",
        moreInfoButton: "Rəsmi Sayt",
